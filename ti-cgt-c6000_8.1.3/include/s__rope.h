...
#  include <s__hash_fun.h>
#endif

#ifndef _STLP_CHAR_TRAITS_H
#  include <s_char_traits.h>
#endif
...
# else /* _STLP_NON_TYPE_TMPL_PARAM_BUG */
  > _Self;
  enum __attribute__((__packed__)) { _Buf_sz = 100};
# endif /* _STLP_NON_TYPE_TMPL_PARAM_BUG */
  // # endif
...
#  define __ROPE_DEPTH_SIZE 46 // __ROPE_MAX_DEPTH + 1
  enum __attribute__((__packed__)) { _S_max_rope_depth = __ROPE_MAX_DEPTH };
...
public:
  ...
  enum __attribute__((__packed__)) { _S_path_cache_len = 4 }; // Must be <= 9 because of _M_path_direction.
  enum __attribute__((__packed__)) { _S_iterator_buf_len = 15 };
...
protected:
  ...
  enum __attribute__((__packed__)) { _S_copy_max = 23 };
