...
#  include <s__ctime.h>                // Needed (for struct tm) by time facets
#endif

#ifndef _STLP_C_LOCALE_H
#  include <s_c_locale.h>
#endif

#ifndef _STLP_IOS_BASE_H
#  include <s__ios_base.h>
#endif

#ifndef _STLP_INTERNAL_IOSTREAM_STRING_H
#  include <s__iostream_string.h>
#endif

#ifndef _STLP_FACETS_FWD_H
#  include <s__facets_fwd.h>
#endif
...
public:
  enum __attribute__((__packed__)) dateorder {no_order, dmy, mdy, ymd, ydm};
};
...
public:
  ...
  static _DATA_ACCESS locale::id id;
