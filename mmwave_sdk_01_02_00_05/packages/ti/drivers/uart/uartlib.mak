...
UART_DRV_SOURCES += uart_xwr16xx.c
UART_R4F_DRV_LIB_OBJECTS  = $(addprefix $(PLATFORM_OBJDIR)/,  $(UART_DRV_SOURCES:.c=.$(R4F_OBJ_EXT)))
...
# Driver Dependency:
###################################################################################
CRC_R4F_DRV_DEPENDS  = $(addprefix $(PLATFORM_OBJDIR)/, $(UART_DRV_SOURCES:.c=.$(R4F_DEP_EXT)))
CRC_C674_DRV_DEPENDS = $(addprefix $(PLATFORM_OBJDIR)/, $(UART_DRV_SOURCES:.c=.$(C674_DEP_EXT)))
