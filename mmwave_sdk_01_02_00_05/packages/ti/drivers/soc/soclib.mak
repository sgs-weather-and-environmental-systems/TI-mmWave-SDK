...
###################################################################################
# Driver Source Files:
# - XWR14xx + XWR16xx: SOC Driver is available only for the R4
###################################################################################
...
SOC_DRV_SOURCES += soc_xwr16xx.c
SOC_DRV_R4_ADDL_SOURCES = soc_xwr16xx_mss.c
SOC_DRV_C674_ADDL_SOURCES = soc_xwr16xx_dss.c
endif
...
# Driver Objects:
# - XWR14xx:
#   SOC driver is available
# - XWR16xx:
#   SOC driver is available for both the DSP and R4
####################################################################################
ifeq ($(MMWAVE_SDK_DEVICE_TYPE),xwr14xx)
