...
CCS_DEBUG_DSS_BIN           = $(MMWAVE_SDK_DEVICE_TYPE)_ccsdebug_dss.bin
...
dssCCSDebug: buildDirectories ccsdebug_dss.cfg $(CCS_DEBUG_DSS_OBJECTS)
	...
	@echo 'Built the CCS Debug DSS Utility [Preparing the BIN Format]'
	@$(GENERATE_BIN) $(CCS_DEBUG_DSS_OUT) $(CCS_DEBUG_DSS_BIN) $(LOAD_ADDRESS)
...
dssCCSDebugClean:
	...
	@$(DEL) $(CCS_DEBUG_DSS_BIN) $(CCS_DEBUG_DSS_MAP)
