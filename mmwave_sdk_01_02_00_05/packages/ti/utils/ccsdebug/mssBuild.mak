...
CCS_DEBUG_MSS_BIN           = $(MMWAVE_SDK_DEVICE_TYPE)_ccsdebug_mss.bin
...
mssCCSDebug: buildDirectories ccsdebug_mss.cfg $(CCS_DEBUG_MSS_OBJECTS)
	...
	@echo 'Built the CCS Debug MSS Utility [Preparing the BIN Format]'
	@$(GENERATE_BIN) $(CCS_DEBUG_MSS_OUT) $(CCS_DEBUG_MSS_BIN) $(LOAD_ADDRESS)
...
mssCCSDebugClean:
	...
	@$(DEL) $(CCS_DEBUG_MSS_BIN) $(CCS_DEBUG_MSS_MAP)
