...
empty =
space =$(empty) $(empty)
CC = "$(C6X_GEN_INSTALL_DIR)/bin/"cl6x -c -me -mv64p
AC = "$(C6X_GEN_INSTALL_DIR)/bin/"cl6x -c -me -mv64p
...
OBJEXT = o64Pe
AOBJEXT = s64Pe
INTERNALDEFS =  -Dti_targets_C64P_big_endian -Dxdc_target_types__=ti/targets/std.h -eo.$(OBJEXT) -ea.$(AOBJEXT) -fr=$(@D) -fs=$(@D) -ppa -ppd=$@.dep 
INTERNALLINKDEFS =  -o $@ -m $@.map
OBJDIR = ./package/lib/lib/dspliba64Pe
...
$(KERNELC64PCOBJS):lib\dsplib.a64Pe.mk
lib\dsplib.a64Pe.mk:
...
#Create Empty rule for dependency
$(KERNELC64PSAOBJS):lib\dsplib.a64Pe.mk
lib\dsplib.a64Pe.mk:
...
lib/dsplib.a64Pe : $(KERNELC64PCOBJS) $(KERNELC64PSAOBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
