...
OBJDIR = ./package/lib/lib/dsplibae64P
...
$(KERNELC64PCOBJS):lib\dsplib.ae64P.mk
lib\dsplib.ae64P.mk:
...
#Create Empty rule for dependency
$(KERNELC64PSAOBJS):lib\dsplib.ae64P.mk
lib\dsplib.ae64P.mk:
...
lib/dsplib.ae64P : $(KERNELC64PCOBJS) $(KERNELC64PSAOBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
