...
#*******************************************************************************
#* FILE NAME: lib/dsplib.ae64Pe.mk
#*
...
empty =
space =$(empty) $(empty)
CC = "$(C6X_GEN_INSTALL_DIR)/bin/"cl6x -c -me -mv64p --abi=eabi
AC = "$(C6X_GEN_INSTALL_DIR)/bin/"cl6x -c -me -mv64p --abi=eabi
...
OBJEXT = oe64Pe
AOBJEXT = se64Pe
INTERNALDEFS =  -Dti_targets_elf_C64P_big_endian -Dxdc_target_types__=ti/targets/std.h -eo.$(OBJEXT) -ea.$(AOBJEXT) -fr=$(@D) -fs=$(@D) -ppa -ppd=$@.dep 
INTERNALLINKDEFS =  -o $@ -m $@.map
OBJDIR = ./package/lib/lib/dsplibae64Pe
...
$(KERNELC64PCOBJS):lib\dsplib.ae64Pe.mk
lib\dsplib.ae64Pe.mk:
...
#Create Empty rule for dependency
$(KERNELC64PSAOBJS):lib\dsplib.ae64Pe.mk
lib\dsplib.ae64Pe.mk:
...
lib/dsplib.ae64Pe : $(KERNELC64PCOBJS) $(KERNELC64PSAOBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
