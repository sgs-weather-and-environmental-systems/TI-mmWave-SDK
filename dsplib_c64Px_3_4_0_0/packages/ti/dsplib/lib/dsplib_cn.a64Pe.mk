...
#*******************************************************************************
#* FILE NAME: lib/dsplib_cn.a64Pe.mk
#*
...
OBJDIR = ./package/lib/lib/dsplib_cna64Pe
...
$(KERNELC64PCOBJS):lib\dsplib_cn.a64Pe.mk
lib\dsplib_cn.a64Pe.mk:
...
lib/dsplib_cn.a64Pe : $(KERNELC64PCOBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
