...
#*******************************************************************************
#* FILE NAME: lib/dsplib_cn.ae64P.mk
#*
...
OBJDIR = ./package/lib/lib/dsplib_cnae64P
...
$(KERNELC64PCOBJS):lib\dsplib_cn.ae64P.mk
lib\dsplib_cn.ae64P.mk:
...
lib/dsplib_cn.ae64P : $(KERNELC64PCOBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
