...
OBJDIR = ./package/lib/lib/dspliba674
...
$(KERNELC674COBJS):lib\dsplib.a674.mk
lib\dsplib.a674.mk:
...
#Create Empty rule for dependency
$(KERNELC674SOBJS):lib\dsplib.a674.mk
lib\dsplib.a674.mk:
...
lib/dsplib.a674 : $(KERNELC674COBJS) $(KERNELC674SOBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
