...
#*******************************************************************************
#* FILE NAME: lib/dsplib_cn.ae674.mk
#*
...
OBJDIR = ./package/lib/lib/dsplib_cnae674
...
$(KERNELC674COBJS):lib\dsplib_cn.ae674.mk
lib\dsplib_cn.ae674.mk:
...
lib/dsplib_cn.ae674 : $(KERNELC674COBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
