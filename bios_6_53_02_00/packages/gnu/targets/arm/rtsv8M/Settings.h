...
{
    return (xdc_Bool)(gnu_targets_arm_rtsv8M_Settings_Module__diagsMask__C != NULL);
}

/* Module_getMask */
static inline xdc_Bits16 gnu_targets_arm_rtsv8M_Settings_Module_getMask( void ) 
{
    return gnu_targets_arm_rtsv8M_Settings_Module__diagsMask__C != NULL ? *gnu_targets_arm_rtsv8M_Settings_Module__diagsMask__C : (xdc_Bits16)0;
}

/* Module_setMask */
static inline xdc_Void gnu_targets_arm_rtsv8M_Settings_Module_setMask( xdc_Bits16 mask ) 
{
    if (gnu_targets_arm_rtsv8M_Settings_Module__diagsMask__C != NULL) {
