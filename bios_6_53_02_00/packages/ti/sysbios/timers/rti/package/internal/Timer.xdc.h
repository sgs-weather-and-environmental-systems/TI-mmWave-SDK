...
/* module */
#ifdef ti_sysbios_timers_rti_Timer_Module__state__VR
#define Timer_module ((ti_sysbios_timers_rti_Timer_Module_State *)(xdcRomStatePtr + ti_sysbios_timers_rti_Timer_Module__state__V_offset))
#define module ((ti_sysbios_timers_rti_Timer_Module_State *)(xdcRomStatePtr + ti_sysbios_timers_rti_Timer_Module__state__V_offset))
#else
