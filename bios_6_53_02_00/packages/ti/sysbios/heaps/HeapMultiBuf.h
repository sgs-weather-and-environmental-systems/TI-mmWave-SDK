...
typedef const ti_sysbios_heaps_HeapBuf_Handle *__CARRAY1_ti_sysbios_heaps_HeapMultiBuf_Instance_State__bufsBySize;
...
typedef const ti_sysbios_heaps_HeapMultiBuf_AddrPair *__CARRAY1_ti_sysbios_heaps_HeapMultiBuf_Instance_State__bufsByAddr;
...
typedef const ti_sysbios_heaps_HeapBuf_Params *__CARRAY1_ti_sysbios_heaps_HeapMultiBuf_bufParams;
...
struct ti_sysbios_heaps_HeapMultiBuf_Fxns__ {
    ...
    xdc_Ptr (*alloc)(ti_sysbios_heaps_HeapMultiBuf_Handle __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb);
    xdc_Void (*free)(ti_sysbios_heaps_HeapMultiBuf_Handle __inst, xdc_Ptr block, xdc_SizeT size);
    xdc_Bool (*isBlocking)(ti_sysbios_heaps_HeapMultiBuf_Handle __inst);
    xdc_Void (*getStats)(ti_sysbios_heaps_HeapMultiBuf_Handle __inst, xdc_runtime_Memory_Stats* stats);
...
__extern xdc_Int ti_sysbios_heaps_HeapMultiBuf_Instance_init__E(ti_sysbios_heaps_HeapMultiBuf_Object *__obj, const ti_sysbios_heaps_HeapMultiBuf_Params *__prms, xdc_runtime_Error_Block *__eb);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_heaps_HeapMultiBuf_Instance_finalize__E, "ti_sysbios_heaps_HeapMultiBuf_Instance_finalize")
__extern void ti_sysbios_heaps_HeapMultiBuf_Instance_finalize__E(ti_sysbios_heaps_HeapMultiBuf_Object *__obj, int __ec);
...
__extern xdc_Ptr ti_sysbios_heaps_HeapMultiBuf_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline ti_sysbios_heaps_HeapMultiBuf_Handle ti_sysbios_heaps_HeapMultiBuf_Handle_downCast(xdc_runtime_IHeap_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&ti_sysbios_heaps_HeapMultiBuf_Module__FXNS__C ? (ti_sysbios_heaps_HeapMultiBuf_Handle)i : (ti_sysbios_heaps_HeapMultiBuf_Handle)0;
}
...
static inline xdc_Bool ti_sysbios_heaps_HeapMultiBuf_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_heaps_HeapMultiBuf_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_heaps_HeapMultiBuf_Module_getMask( void ) 
{
    return ti_sysbios_heaps_HeapMultiBuf_Module__diagsMask__C != NULL ? *ti_sysbios_heaps_HeapMultiBuf_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_heaps_HeapMultiBuf_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_heaps_HeapMultiBuf_Module__diagsMask__C != NULL) {
