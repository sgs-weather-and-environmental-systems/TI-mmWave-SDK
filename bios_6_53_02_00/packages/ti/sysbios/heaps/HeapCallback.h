...
/* AllocInstFxn */
typedef xdc_Ptr (*ti_sysbios_heaps_HeapCallback_AllocInstFxn)(xdc_UArg __arg1, xdc_SizeT __arg2, xdc_SizeT __arg3);

/* CreateInstFxn */
typedef xdc_UArg (*ti_sysbios_heaps_HeapCallback_CreateInstFxn)(xdc_UArg __arg1);

/* DeleteInstFxn */
typedef xdc_Void (*ti_sysbios_heaps_HeapCallback_DeleteInstFxn)(xdc_UArg __arg1);

/* FreeInstFxn */
typedef xdc_Void (*ti_sysbios_heaps_HeapCallback_FreeInstFxn)(xdc_UArg __arg1, xdc_Ptr __arg2, xdc_SizeT __arg3);

/* GetStatsInstFxn */
typedef xdc_Void (*ti_sysbios_heaps_HeapCallback_GetStatsInstFxn)(xdc_UArg __arg1, xdc_runtime_Memory_Stats* __arg2);

/* InitInstFxn */
typedef xdc_UArg (*ti_sysbios_heaps_HeapCallback_InitInstFxn)(xdc_UArg __arg1);

/* IsBlockingInstFxn */
typedef xdc_Bool (*ti_sysbios_heaps_HeapCallback_IsBlockingInstFxn)(xdc_UArg __arg1);
...
struct ti_sysbios_heaps_HeapCallback_Fxns__ {
    ...
    xdc_Ptr (*alloc)(ti_sysbios_heaps_HeapCallback_Handle __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb);
    xdc_Void (*free)(ti_sysbios_heaps_HeapCallback_Handle __inst, xdc_Ptr block, xdc_SizeT size);
    xdc_Bool (*isBlocking)(ti_sysbios_heaps_HeapCallback_Handle __inst);
    xdc_Void (*getStats)(ti_sysbios_heaps_HeapCallback_Handle __inst, xdc_runtime_Memory_Stats* stats);
...
__extern xdc_Void ti_sysbios_heaps_HeapCallback_Instance_init__E(ti_sysbios_heaps_HeapCallback_Object *__obj, const ti_sysbios_heaps_HeapCallback_Params *__prms);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_heaps_HeapCallback_Instance_finalize__E, "ti_sysbios_heaps_HeapCallback_Instance_finalize")
__extern void ti_sysbios_heaps_HeapCallback_Instance_finalize__E(ti_sysbios_heaps_HeapCallback_Object *__obj);
...
__extern xdc_Ptr ti_sysbios_heaps_HeapCallback_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline ti_sysbios_heaps_HeapCallback_Handle ti_sysbios_heaps_HeapCallback_Handle_downCast(xdc_runtime_IHeap_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&ti_sysbios_heaps_HeapCallback_Module__FXNS__C ? (ti_sysbios_heaps_HeapCallback_Handle)i : (ti_sysbios_heaps_HeapCallback_Handle)0;
}
...
static inline xdc_Bool ti_sysbios_heaps_HeapCallback_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_heaps_HeapCallback_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_heaps_HeapCallback_Module_getMask( void ) 
{
    return ti_sysbios_heaps_HeapCallback_Module__diagsMask__C != NULL ? *ti_sysbios_heaps_HeapCallback_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_heaps_HeapCallback_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_heaps_HeapCallback_Module__diagsMask__C != NULL) {
