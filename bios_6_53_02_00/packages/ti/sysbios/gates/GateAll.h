...
struct ti_sysbios_gates_GateAll_Fxns__ {
    ...
    xdc_IArg (*enter)(ti_sysbios_gates_GateAll_Handle __inst);
    xdc_Void (*leave)(ti_sysbios_gates_GateAll_Handle __inst, xdc_IArg key);
...
__extern xdc_Void ti_sysbios_gates_GateAll_Instance_init__E(ti_sysbios_gates_GateAll_Object *__obj, const ti_sysbios_gates_GateAll_Params *__prms);
...
__extern xdc_Ptr ti_sysbios_gates_GateAll_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline ti_sysbios_gates_GateAll_Handle ti_sysbios_gates_GateAll_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&ti_sysbios_gates_GateAll_Module__FXNS__C ? (ti_sysbios_gates_GateAll_Handle)i : (ti_sysbios_gates_GateAll_Handle)0;
}
...
static inline xdc_Bool ti_sysbios_gates_GateAll_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_gates_GateAll_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_gates_GateAll_Module_getMask( void ) 
{
    return ti_sysbios_gates_GateAll_Module__diagsMask__C != NULL ? *ti_sysbios_gates_GateAll_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_gates_GateAll_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_gates_GateAll_Module__diagsMask__C != NULL) {
