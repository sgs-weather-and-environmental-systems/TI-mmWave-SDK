 ...
 *
 *  PSCL configuration library for evm6748, extended for 408MHz.
 *
 */
...
//  ----  ------- ------  ---------    ----------  ---------      --------- 
   ...
   {0x10, 0x8000, 0x8000, PMI_LOCK,      0x1E6,         0   }, //  408 MHz
};
...
//  -----------------------  -----------------------  -------  ------ -------   
   ...
   {&PSCL_pllCfgTableCPU[3], &PSCL_divCfgTableCPU[3], &clkCfg, 408000, 1300 },
};
