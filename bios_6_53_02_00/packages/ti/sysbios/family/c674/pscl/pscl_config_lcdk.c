 ...
 *  ======== pscl_config_lcdk.c ========
 *
 *  PSCL configuration library for the LCDK.
 *
 */
...
//  -----------------------  -----------------------  -------  ------ -------   
   {&PSCL_pllCfgTableCPU[0], &PSCL_divCfgTableCPU[0], &clkCfg, 100000, 1300 },
   {&PSCL_pllCfgTableCPU[1], &PSCL_divCfgTableCPU[1], &clkCfg, 200000, 1300 },
   {&PSCL_pllCfgTableCPU[2], &PSCL_divCfgTableCPU[2], &clkCfg, 300000, 1300 },
...
//        PLL config             divider config       clk cfg   freq  voltage
//  -----------------------  -----------------------  -------  ------ -------   
   {&PSCL_pllCfgTablePER[0], &PSCL_divCfgTablePER[0],   NULL,  264000, 1300 },
   {&PSCL_pllCfgTablePER[1], &PSCL_divCfgTablePER[1],   NULL,  300000, 1300 },
};
