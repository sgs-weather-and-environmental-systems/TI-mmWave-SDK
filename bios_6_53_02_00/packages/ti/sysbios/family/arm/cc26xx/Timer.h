...
struct ti_sysbios_family_arm_cc26xx_Timer_Fxns__ {
    ...
    xdc_UInt32 (*getMaxTicks)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst);
    xdc_Void (*setNextTick)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 ticks);
    xdc_Void (*start)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst);
    xdc_Void (*stop)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst);
    xdc_Void (*setPeriod)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 period);
    xdc_Bool (*setPeriodMicroSecs)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 microsecs);
    xdc_UInt32 (*getPeriod)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst);
    xdc_UInt32 (*getCount)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst);
    xdc_Void (*getFreq)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_runtime_Types_FreqHz* freq);
    ti_sysbios_interfaces_ITimer_FuncPtr (*getFunc)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UArg* arg);
    xdc_Void (*setFunc)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, ti_sysbios_interfaces_ITimer_FuncPtr fxn, xdc_UArg arg);
    xdc_Void (*trigger)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 cycles);
    xdc_UInt32 (*getExpiredCounts)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst);
    xdc_UInt32 (*getExpiredTicks)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 tickPeriod);
    xdc_UInt32 (*getCurrentTick)(ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_Bool save);
...
__extern xdc_Int ti_sysbios_family_arm_cc26xx_Timer_Instance_init__E(ti_sysbios_family_arm_cc26xx_Timer_Object *__obj, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_family_arm_cc26xx_Timer_Params *__prms, xdc_runtime_Error_Block *__eb);
...
__extern void ti_sysbios_family_arm_cc26xx_Timer_Instance_finalize__E(ti_sysbios_family_arm_cc26xx_Timer_Object *__obj, int __ec);

/* create */
xdc__CODESECT(ti_sysbios_family_arm_cc26xx_Timer_create, "ti_sysbios_family_arm_cc26xx_Timer_create")
__extern ti_sysbios_family_arm_cc26xx_Timer_Handle ti_sysbios_family_arm_cc26xx_Timer_create( xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_family_arm_cc26xx_Timer_Params *__prms, xdc_runtime_Error_Block *__eb );

/* construct */
xdc__CODESECT(ti_sysbios_family_arm_cc26xx_Timer_construct, "ti_sysbios_family_arm_cc26xx_Timer_construct")
__extern void ti_sysbios_family_arm_cc26xx_Timer_construct( ti_sysbios_family_arm_cc26xx_Timer_Struct *__obj, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_family_arm_cc26xx_Timer_Params *__prms, xdc_runtime_Error_Block *__eb );
...
__extern xdc_Ptr ti_sysbios_family_arm_cc26xx_Timer_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
__extern xdc_UInt32 ti_sysbios_family_arm_cc26xx_Timer_getMaxTicks__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst );
...
__extern xdc_Void ti_sysbios_family_arm_cc26xx_Timer_setNextTick__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 ticks );
...
__extern xdc_Void ti_sysbios_family_arm_cc26xx_Timer_start__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst );
...
__extern xdc_Void ti_sysbios_family_arm_cc26xx_Timer_stop__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst );
...
__extern xdc_Void ti_sysbios_family_arm_cc26xx_Timer_setPeriod__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 period );
...
__extern xdc_Bool ti_sysbios_family_arm_cc26xx_Timer_setPeriodMicroSecs__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 microsecs );
...
__extern xdc_UInt32 ti_sysbios_family_arm_cc26xx_Timer_getPeriod__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst );
...
__extern xdc_UInt32 ti_sysbios_family_arm_cc26xx_Timer_getCount__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst );
...
__extern xdc_Void ti_sysbios_family_arm_cc26xx_Timer_getFreq__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_runtime_Types_FreqHz *freq );
...
__extern ti_sysbios_interfaces_ITimer_FuncPtr ti_sysbios_family_arm_cc26xx_Timer_getFunc__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UArg *arg );
...
__extern xdc_Void ti_sysbios_family_arm_cc26xx_Timer_setFunc__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, ti_sysbios_interfaces_ITimer_FuncPtr fxn, xdc_UArg arg );
...
__extern xdc_Void ti_sysbios_family_arm_cc26xx_Timer_trigger__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 cycles );
...
__extern xdc_UInt32 ti_sysbios_family_arm_cc26xx_Timer_getExpiredCounts__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst );
...
__extern xdc_UInt32 ti_sysbios_family_arm_cc26xx_Timer_getExpiredTicks__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_UInt32 tickPeriod );
...
__extern xdc_UInt32 ti_sysbios_family_arm_cc26xx_Timer_getCurrentTick__E( ti_sysbios_family_arm_cc26xx_Timer_Handle __inst, xdc_Bool save );
...
static inline ti_sysbios_family_arm_cc26xx_Timer_Handle ti_sysbios_family_arm_cc26xx_Timer_Handle_downCast(ti_sysbios_interfaces_ITimer_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&ti_sysbios_family_arm_cc26xx_Timer_Module__FXNS__C ? (ti_sysbios_family_arm_cc26xx_Timer_Handle)i : (ti_sysbios_family_arm_cc26xx_Timer_Handle)0;
}
...
static inline xdc_Bool ti_sysbios_family_arm_cc26xx_Timer_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_family_arm_cc26xx_Timer_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_cc26xx_Timer_Module_getMask( void ) 
{
    return ti_sysbios_family_arm_cc26xx_Timer_Module__diagsMask__C != NULL ? *ti_sysbios_family_arm_cc26xx_Timer_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_cc26xx_Timer_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_cc26xx_Timer_Module__diagsMask__C != NULL) {
