...
typedef xdc_Bool __CARRAY1_ti_sysbios_family_arm_ducati_Core_Module_State__gateEntered[2];
...
typedef xdc_UInt __CARRAY1_ti_sysbios_family_arm_ducati_Core_Module_State__schedulerInts[2];
...
typedef const xdc_Char *__CARRAY1_ti_sysbios_family_arm_ducati_Core_Module_State__core1HwiStack;
...
static inline xdc_Bool ti_sysbios_family_arm_ducati_Core_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_family_arm_ducati_Core_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_ducati_Core_Module_getMask( void ) 
{
    return ti_sysbios_family_arm_ducati_Core_Module__diagsMask__C != NULL ? *ti_sysbios_family_arm_ducati_Core_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_ducati_Core_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_ducati_Core_Module__diagsMask__C != NULL) {
