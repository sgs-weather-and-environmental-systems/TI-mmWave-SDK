...
typedef xdc_UInt32 __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole0[3];
typedef xdc_UInt32 __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole0[3];
typedef __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole0 __TA_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole0;
typedef xdc_UInt32 __T1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole1;
typedef xdc_UInt32 __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole1[10];
typedef xdc_UInt32 __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole1[10];
typedef __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole1 __TA_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole1;
typedef xdc_UInt32 __T1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole2;
typedef xdc_UInt32 __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole2[3];
typedef xdc_UInt32 __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole2[3];
typedef __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole2 __TA_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole2;
typedef xdc_UInt32 __T1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole3;
typedef xdc_UInt32 __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole3[5];
typedef xdc_UInt32 __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole3[5];
typedef __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole3 __TA_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__hole3;
typedef xdc_UInt32 __T1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__ILR;
typedef xdc_UInt32 __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__ILR[128];
typedef xdc_UInt32 __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__ILR[128];
typedef __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__ILR __TA_ti_sysbios_family_arm_a8_intcps_Hwi_Intc__ILR;
...
typedef xdc_Ptr *__ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Instance_State__hookEnv;
typedef const xdc_Ptr *__CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Instance_State__hookEnv;
typedef __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Instance_State__hookEnv __TA_ti_sysbios_family_arm_a8_intcps_Hwi_Instance_State__hookEnv;

/* Module_State */
typedef xdc_Char __T1_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__fiqStack;
typedef xdc_Char *__ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__fiqStack;
typedef const xdc_Char *__CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__fiqStack;
typedef __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__fiqStack __TA_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__fiqStack;
typedef ti_sysbios_family_arm_a8_intcps_Hwi_Handle __T1_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__dispatchTable;
typedef ti_sysbios_family_arm_a8_intcps_Hwi_Handle __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__dispatchTable[128];
typedef ti_sysbios_family_arm_a8_intcps_Hwi_Handle __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__dispatchTable[128];
typedef __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__dispatchTable __TA_ti_sysbios_family_arm_a8_intcps_Hwi_Module_State__dispatchTable;
...
/* swiRestoreHwi */
typedef xdc_Void (*CT__ti_sysbios_family_arm_a8_intcps_Hwi_swiRestoreHwi)(xdc_UInt __arg1);
...
/* taskRestoreHwi */
typedef xdc_Void (*CT__ti_sysbios_family_arm_a8_intcps_Hwi_taskRestoreHwi)(xdc_UInt __arg1);
...
typedef struct { int length; ti_sysbios_family_arm_a8_intcps_Hwi_HookSet *elem; } __ARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_hooks;
typedef struct { int length; ti_sysbios_family_arm_a8_intcps_Hwi_HookSet const *elem; } __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_hooks;
typedef __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_hooks __TA_ti_sysbios_family_arm_a8_intcps_Hwi_hooks;
typedef __CARRAY1_ti_sysbios_family_arm_a8_intcps_Hwi_hooks CT__ti_sysbios_family_arm_a8_intcps_Hwi_hooks;
...
struct ti_sysbios_family_arm_a8_intcps_Hwi_Struct {
    ...
    ti_sysbios_family_arm_a8_intcps_Hwi_Type __f0;
    xdc_UInt __f1;
    xdc_UArg __f2;
    ti_sysbios_family_arm_a8_intcps_Hwi_FuncPtr __f3;
    ti_sysbios_family_arm_a8_intcps_Hwi_Irp __f4;
    __TA_ti_sysbios_family_arm_a8_intcps_Hwi_Instance_State__hookEnv __f5;
...
struct ti_sysbios_family_arm_a8_intcps_Hwi_Fxns__ {
    ...
    ti_sysbios_interfaces_IHwi_FuncPtr (*getFunc)(ti_sysbios_family_arm_a8_intcps_Hwi_Handle __inst, xdc_UArg* arg);
    xdc_Void (*setFunc)(ti_sysbios_family_arm_a8_intcps_Hwi_Handle __inst, ti_sysbios_interfaces_IHwi_FuncPtr fxn, xdc_UArg arg);
    xdc_Ptr (*getHookContext)(ti_sysbios_family_arm_a8_intcps_Hwi_Handle __inst, xdc_Int id);
    xdc_Void (*setHookContext)(ti_sysbios_family_arm_a8_intcps_Hwi_Handle __inst, xdc_Int id, xdc_Ptr hookContext);
    ti_sysbios_interfaces_IHwi_Irp (*getIrp)(ti_sysbios_family_arm_a8_intcps_Hwi_Handle __inst);
...
__extern xdc_Int ti_sysbios_family_arm_a8_intcps_Hwi_Instance_init__E(ti_sysbios_family_arm_a8_intcps_Hwi_Object *__obj, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arm_a8_intcps_Hwi_Params *__prms, xdc_runtime_Error_Block *__eb);
...
__extern void ti_sysbios_family_arm_a8_intcps_Hwi_Instance_finalize__E(ti_sysbios_family_arm_a8_intcps_Hwi_Object *__obj, int __ec);

/* create */
xdc__CODESECT(ti_sysbios_family_arm_a8_intcps_Hwi_create, "ti_sysbios_family_arm_a8_intcps_Hwi_create")
__extern ti_sysbios_family_arm_a8_intcps_Hwi_Handle ti_sysbios_family_arm_a8_intcps_Hwi_create( xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arm_a8_intcps_Hwi_Params *__prms, xdc_runtime_Error_Block *__eb );

/* construct */
xdc__CODESECT(ti_sysbios_family_arm_a8_intcps_Hwi_construct, "ti_sysbios_family_arm_a8_intcps_Hwi_construct")
__extern void ti_sysbios_family_arm_a8_intcps_Hwi_construct( ti_sysbios_family_arm_a8_intcps_Hwi_Struct *__obj, xdc_Int intNum, ti_sysbios_interfaces_IHwi_FuncPtr hwiFxn, const ti_sysbios_family_arm_a8_intcps_Hwi_Params *__prms, xdc_runtime_Error_Block *__eb );
...
__extern xdc_Ptr ti_sysbios_family_arm_a8_intcps_Hwi_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline ti_sysbios_family_arm_a8_intcps_Hwi_Handle ti_sysbios_family_arm_a8_intcps_Hwi_Handle_downCast(ti_sysbios_interfaces_IHwi_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&ti_sysbios_family_arm_a8_intcps_Hwi_Module__FXNS__C ? (ti_sysbios_family_arm_a8_intcps_Hwi_Handle)i : (ti_sysbios_family_arm_a8_intcps_Hwi_Handle)0;
}
...
static inline xdc_Bool ti_sysbios_family_arm_a8_intcps_Hwi_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_family_arm_a8_intcps_Hwi_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_a8_intcps_Hwi_Module_getMask( void ) 
{
    return ti_sysbios_family_arm_a8_intcps_Hwi_Module__diagsMask__C != NULL ? *ti_sysbios_family_arm_a8_intcps_Hwi_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_a8_intcps_Hwi_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_a8_intcps_Hwi_Module__diagsMask__C != NULL) {
...
{
    if (prms) {
        ti_sysbios_family_arm_a8_intcps_Hwi_Params__init__S(prms, 0, sizeof(ti_sysbios_family_arm_a8_intcps_Hwi_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
#endif
static inline ti_sysbios_family_arm_a8_intcps_Hwi_Handle ti_sysbios_family_arm_a8_intcps_Hwi_Module_State_nonPluggedHwi();
static inline ti_sysbios_family_arm_a8_intcps_Hwi_Handle ti_sysbios_family_arm_a8_intcps_Hwi_Module_State_nonPluggedHwi()
{
