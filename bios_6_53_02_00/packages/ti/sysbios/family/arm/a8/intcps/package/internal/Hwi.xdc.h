...
/* module */
#ifdef ti_sysbios_family_arm_a8_intcps_Hwi_Module__state__VR
#define Hwi_module ((ti_sysbios_family_arm_a8_intcps_Hwi_Module_State *)(xdcRomStatePtr + ti_sysbios_family_arm_a8_intcps_Hwi_Module__state__V_offset))
#define module ((ti_sysbios_family_arm_a8_intcps_Hwi_Module_State *)(xdcRomStatePtr + ti_sysbios_family_arm_a8_intcps_Hwi_Module__state__V_offset))
#else
