...
typedef xdc_UInt32 *__ARRAY1_ti_sysbios_family_arm_a8_Mmu_Module_State__tableBuf;
typedef const xdc_UInt32 *__CARRAY1_ti_sysbios_family_arm_a8_Mmu_Module_State__tableBuf;
typedef __ARRAY1_ti_sysbios_family_arm_a8_Mmu_Module_State__tableBuf __TA_ti_sysbios_family_arm_a8_Mmu_Module_State__tableBuf;
...
static inline xdc_Bool ti_sysbios_family_arm_a8_Mmu_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_family_arm_a8_Mmu_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_family_arm_a8_Mmu_Module_getMask( void ) 
{
    return ti_sysbios_family_arm_a8_Mmu_Module__diagsMask__C != NULL ? *ti_sysbios_family_arm_a8_Mmu_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_family_arm_a8_Mmu_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_family_arm_a8_Mmu_Module__diagsMask__C != NULL) {
