...
#define ti_sysbios_family_arm_TaskSupport___VERS 200
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__diagsEnabled__CR
#define ti_sysbios_family_arm_TaskSupport_Module__diagsEnabled__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__diagsEnabled*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__diagsEnabled__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__diagsEnabled (ti_sysbios_family_arm_TaskSupport_Module__diagsEnabled__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__diagsIncluded__CR
#define ti_sysbios_family_arm_TaskSupport_Module__diagsIncluded__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__diagsIncluded*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__diagsIncluded__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__diagsIncluded (ti_sysbios_family_arm_TaskSupport_Module__diagsIncluded__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__diagsMask__CR
#define ti_sysbios_family_arm_TaskSupport_Module__diagsMask__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__diagsMask*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__diagsMask__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__diagsMask (ti_sysbios_family_arm_TaskSupport_Module__diagsMask__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__gateObj__CR
#define ti_sysbios_family_arm_TaskSupport_Module__gateObj__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__gateObj*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__gateObj__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__gateObj (ti_sysbios_family_arm_TaskSupport_Module__gateObj__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__gatePrms__CR
#define ti_sysbios_family_arm_TaskSupport_Module__gatePrms__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__gatePrms*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__gatePrms__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__gatePrms (ti_sysbios_family_arm_TaskSupport_Module__gatePrms__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__id__CR
#define ti_sysbios_family_arm_TaskSupport_Module__id__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__id*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__id__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__id (ti_sysbios_family_arm_TaskSupport_Module__id__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__loggerDefined__CR
#define ti_sysbios_family_arm_TaskSupport_Module__loggerDefined__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__loggerDefined*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__loggerDefined__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__loggerDefined (ti_sysbios_family_arm_TaskSupport_Module__loggerDefined__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__loggerObj__CR
#define ti_sysbios_family_arm_TaskSupport_Module__loggerObj__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__loggerObj*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__loggerObj__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__loggerObj (ti_sysbios_family_arm_TaskSupport_Module__loggerObj__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__loggerFxn0__CR
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn0__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__loggerFxn0*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__loggerFxn0__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn0 (ti_sysbios_family_arm_TaskSupport_Module__loggerFxn0__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__loggerFxn1__CR
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn1__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__loggerFxn1*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__loggerFxn1__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn1 (ti_sysbios_family_arm_TaskSupport_Module__loggerFxn1__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__loggerFxn2__CR
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn2__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__loggerFxn2*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__loggerFxn2__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn2 (ti_sysbios_family_arm_TaskSupport_Module__loggerFxn2__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__loggerFxn4__CR
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn4__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__loggerFxn4*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__loggerFxn4__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn4 (ti_sysbios_family_arm_TaskSupport_Module__loggerFxn4__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Module__loggerFxn8__CR
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn8__C (*((CT__ti_sysbios_family_arm_TaskSupport_Module__loggerFxn8*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__loggerFxn8__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Module__loggerFxn8 (ti_sysbios_family_arm_TaskSupport_Module__loggerFxn8__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Object__count__CR
#define ti_sysbios_family_arm_TaskSupport_Object__count__C (*((CT__ti_sysbios_family_arm_TaskSupport_Object__count*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Object__count__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Object__count (ti_sysbios_family_arm_TaskSupport_Object__count__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Object__heap__CR
#define ti_sysbios_family_arm_TaskSupport_Object__heap__C (*((CT__ti_sysbios_family_arm_TaskSupport_Object__heap*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Object__heap__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Object__heap (ti_sysbios_family_arm_TaskSupport_Object__heap__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Object__sizeof__CR
#define ti_sysbios_family_arm_TaskSupport_Object__sizeof__C (*((CT__ti_sysbios_family_arm_TaskSupport_Object__sizeof*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Object__sizeof__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Object__sizeof (ti_sysbios_family_arm_TaskSupport_Object__sizeof__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_Object__table__CR
#define ti_sysbios_family_arm_TaskSupport_Object__table__C (*((CT__ti_sysbios_family_arm_TaskSupport_Object__table*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Object__table__C_offset)))
#else
#define ti_sysbios_family_arm_TaskSupport_Object__table (ti_sysbios_family_arm_TaskSupport_Object__table__C)
#endif
...
#ifdef ti_sysbios_family_arm_TaskSupport_defaultStackSize__CR
#define ti_sysbios_family_arm_TaskSupport_defaultStackSize (*((CT__ti_sysbios_family_arm_TaskSupport_defaultStackSize*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_defaultStackSize__C_offset)))
#else
...
#ifdef ti_sysbios_family_arm_TaskSupport_stackAlignment__CR
#define ti_sysbios_family_arm_TaskSupport_stackAlignment (*((CT__ti_sysbios_family_arm_TaskSupport_stackAlignment*)(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_stackAlignment__C_offset)))
#else
...
#else
#define ti_sysbios_family_arm_TaskSupport_Module__FXNS__C (*(xdcRomConstPtr + ti_sysbios_family_arm_TaskSupport_Module__FXNS__C_offset))
#endif
