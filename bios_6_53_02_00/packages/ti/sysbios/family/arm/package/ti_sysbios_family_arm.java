...
public class ti_sysbios_family_arm
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.ae9',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.aea8fnv',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.aer5f',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.aer4f',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.aa9fg',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.aa15fg',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.aa53fg',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.aem4f',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.am4fg',\n");
            sb.append("'lib/sysbios/debug/ti.sysbios.family.arm.arm4f',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.ae9', {target: 'ti.targets.arm.elf.Arm9', suffix: 'e9'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.aea8fnv', {target: 'ti.targets.arm.elf.A8Fnv', suffix: 'ea8fnv'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.aer4f', {target: 'ti.targets.arm.elf.R4F', suffix: 'er4f'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.aa9fg', {target: 'gnu.targets.arm.A9F', suffix: 'a9fg'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.aa15fg', {target: 'gnu.targets.arm.A15F', suffix: 'a15fg'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.aa53fg', {target: 'gnu.targets.arm.A53F', suffix: 'a53fg'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.aem4f', {target: 'ti.targets.arm.elf.M4F', suffix: 'em4f'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.am4fg', {target: 'gnu.targets.arm.M4F', suffix: 'm4fg'}],\n");
            sb.append("['lib/sysbios/debug/ti.sysbios.family.arm.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
        sb.append("];\n");
