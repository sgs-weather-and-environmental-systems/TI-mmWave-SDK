...
typedef const struct ti_sysbios_family_arm_IntrinsicsSupport_Fxns__* ti_sysbios_family_arm_IntrinsicsSupport_Module;
...
typedef const struct ti_sysbios_family_arm_TaskSupport_Fxns__* ti_sysbios_family_arm_TaskSupport_Module;
