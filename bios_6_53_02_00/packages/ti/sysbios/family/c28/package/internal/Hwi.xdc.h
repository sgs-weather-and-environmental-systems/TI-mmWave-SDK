...
/* getCoreStackInfo */
#undef ti_sysbios_family_c28_Hwi_getCoreStackInfo
...
#define ti_sysbios_family_c28_Hwi_Instance_init ti_sysbios_family_c28_Hwi_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_family_c28_Hwi_Instance_finalize
#define ti_sysbios_family_c28_Hwi_Instance_finalize ti_sysbios_family_c28_Hwi_Instance_finalize__E

/* module */
#ifdef ti_sysbios_family_c28_Hwi_Module__state__VR
#define Hwi_module ((ti_sysbios_family_c28_Hwi_Module_State *)(xdcRomStatePtr + ti_sysbios_family_c28_Hwi_Module__state__V_offset))
#define module ((ti_sysbios_family_c28_Hwi_Module_State *)(xdcRomStatePtr + ti_sysbios_family_c28_Hwi_Module__state__V_offset))
#else
