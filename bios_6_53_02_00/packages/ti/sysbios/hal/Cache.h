...
static inline xdc_Bool ti_sysbios_hal_Cache_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_hal_Cache_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_hal_Cache_Module_getMask( void ) 
{
    return ti_sysbios_hal_Cache_Module__diagsMask__C != NULL ? *ti_sysbios_hal_Cache_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_hal_Cache_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_hal_Cache_Module__diagsMask__C != NULL) {
