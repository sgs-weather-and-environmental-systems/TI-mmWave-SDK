...
struct ti_sysbios_hal_TimerNull_Fxns__ {
    ...
    xdc_UInt32 (*getMaxTicks)(ti_sysbios_hal_TimerNull_Handle __inst);
    xdc_Void (*setNextTick)(ti_sysbios_hal_TimerNull_Handle __inst, xdc_UInt32 ticks);
    xdc_Void (*start)(ti_sysbios_hal_TimerNull_Handle __inst);
    xdc_Void (*stop)(ti_sysbios_hal_TimerNull_Handle __inst);
    xdc_Void (*setPeriod)(ti_sysbios_hal_TimerNull_Handle __inst, xdc_UInt32 period);
    xdc_Bool (*setPeriodMicroSecs)(ti_sysbios_hal_TimerNull_Handle __inst, xdc_UInt32 microsecs);
    xdc_UInt32 (*getPeriod)(ti_sysbios_hal_TimerNull_Handle __inst);
    xdc_UInt32 (*getCount)(ti_sysbios_hal_TimerNull_Handle __inst);
    xdc_Void (*getFreq)(ti_sysbios_hal_TimerNull_Handle __inst, xdc_runtime_Types_FreqHz* freq);
    ti_sysbios_interfaces_ITimer_FuncPtr (*getFunc)(ti_sysbios_hal_TimerNull_Handle __inst, xdc_UArg* arg);
    xdc_Void (*setFunc)(ti_sysbios_hal_TimerNull_Handle __inst, ti_sysbios_interfaces_ITimer_FuncPtr fxn, xdc_UArg arg);
    xdc_Void (*trigger)(ti_sysbios_hal_TimerNull_Handle __inst, xdc_UInt32 cycles);
    xdc_UInt32 (*getExpiredCounts)(ti_sysbios_hal_TimerNull_Handle __inst);
    xdc_UInt32 (*getExpiredTicks)(ti_sysbios_hal_TimerNull_Handle __inst, xdc_UInt32 tickPeriod);
    xdc_UInt32 (*getCurrentTick)(ti_sysbios_hal_TimerNull_Handle __inst, xdc_Bool save);
...
__extern xdc_Int ti_sysbios_hal_TimerNull_Instance_init__E(ti_sysbios_hal_TimerNull_Object *__obj, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_hal_TimerNull_Params *__prms, xdc_runtime_Error_Block *__eb);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_hal_TimerNull_Instance_finalize__E, "ti_sysbios_hal_TimerNull_Instance_finalize")
__extern void ti_sysbios_hal_TimerNull_Instance_finalize__E(ti_sysbios_hal_TimerNull_Object *__obj, int __ec);
...
__extern xdc_Ptr ti_sysbios_hal_TimerNull_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline ti_sysbios_hal_TimerNull_Handle ti_sysbios_hal_TimerNull_Handle_downCast(ti_sysbios_interfaces_ITimer_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&ti_sysbios_hal_TimerNull_Module__FXNS__C ? (ti_sysbios_hal_TimerNull_Handle)i : (ti_sysbios_hal_TimerNull_Handle)0;
}
...
static inline xdc_Bool ti_sysbios_hal_TimerNull_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_hal_TimerNull_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_hal_TimerNull_Module_getMask( void ) 
{
    return ti_sysbios_hal_TimerNull_Module__diagsMask__C != NULL ? *ti_sysbios_hal_TimerNull_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_hal_TimerNull_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_hal_TimerNull_Module__diagsMask__C != NULL) {
