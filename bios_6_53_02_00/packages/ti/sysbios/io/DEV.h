...
#define ti_sysbios_io_DEV___VERS 200
...
typedef const ti_sysbios_io_DEV_Handle *__CARRAY1_ti_sysbios_io_DEV_Module_State__table;
...
#ifdef ti_sysbios_io_DEV_Module__diagsEnabled__CR
#define ti_sysbios_io_DEV_Module__diagsEnabled__C (*((CT__ti_sysbios_io_DEV_Module__diagsEnabled*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__diagsEnabled__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__diagsEnabled (ti_sysbios_io_DEV_Module__diagsEnabled__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__diagsIncluded__CR
#define ti_sysbios_io_DEV_Module__diagsIncluded__C (*((CT__ti_sysbios_io_DEV_Module__diagsIncluded*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__diagsIncluded__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__diagsIncluded (ti_sysbios_io_DEV_Module__diagsIncluded__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__diagsMask__CR
#define ti_sysbios_io_DEV_Module__diagsMask__C (*((CT__ti_sysbios_io_DEV_Module__diagsMask*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__diagsMask__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__diagsMask (ti_sysbios_io_DEV_Module__diagsMask__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__gateObj__CR
#define ti_sysbios_io_DEV_Module__gateObj__C (*((CT__ti_sysbios_io_DEV_Module__gateObj*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__gateObj__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__gateObj (ti_sysbios_io_DEV_Module__gateObj__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__gatePrms__CR
#define ti_sysbios_io_DEV_Module__gatePrms__C (*((CT__ti_sysbios_io_DEV_Module__gatePrms*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__gatePrms__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__gatePrms (ti_sysbios_io_DEV_Module__gatePrms__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__id__CR
#define ti_sysbios_io_DEV_Module__id__C (*((CT__ti_sysbios_io_DEV_Module__id*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__id__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__id (ti_sysbios_io_DEV_Module__id__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__loggerDefined__CR
#define ti_sysbios_io_DEV_Module__loggerDefined__C (*((CT__ti_sysbios_io_DEV_Module__loggerDefined*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerDefined__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__loggerDefined (ti_sysbios_io_DEV_Module__loggerDefined__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__loggerObj__CR
#define ti_sysbios_io_DEV_Module__loggerObj__C (*((CT__ti_sysbios_io_DEV_Module__loggerObj*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerObj__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__loggerObj (ti_sysbios_io_DEV_Module__loggerObj__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__loggerFxn0__CR
#define ti_sysbios_io_DEV_Module__loggerFxn0__C (*((CT__ti_sysbios_io_DEV_Module__loggerFxn0*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn0__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__loggerFxn0 (ti_sysbios_io_DEV_Module__loggerFxn0__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__loggerFxn1__CR
#define ti_sysbios_io_DEV_Module__loggerFxn1__C (*((CT__ti_sysbios_io_DEV_Module__loggerFxn1*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn1__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__loggerFxn1 (ti_sysbios_io_DEV_Module__loggerFxn1__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__loggerFxn2__CR
#define ti_sysbios_io_DEV_Module__loggerFxn2__C (*((CT__ti_sysbios_io_DEV_Module__loggerFxn2*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn2__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__loggerFxn2 (ti_sysbios_io_DEV_Module__loggerFxn2__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__loggerFxn4__CR
#define ti_sysbios_io_DEV_Module__loggerFxn4__C (*((CT__ti_sysbios_io_DEV_Module__loggerFxn4*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn4__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__loggerFxn4 (ti_sysbios_io_DEV_Module__loggerFxn4__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Module__loggerFxn8__CR
#define ti_sysbios_io_DEV_Module__loggerFxn8__C (*((CT__ti_sysbios_io_DEV_Module__loggerFxn8*)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn8__C_offset)))
#else
#define ti_sysbios_io_DEV_Module__loggerFxn8 (ti_sysbios_io_DEV_Module__loggerFxn8__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Object__count__CR
#define ti_sysbios_io_DEV_Object__count__C (*((CT__ti_sysbios_io_DEV_Object__count*)(xdcRomConstPtr + ti_sysbios_io_DEV_Object__count__C_offset)))
#else
#define ti_sysbios_io_DEV_Object__count (ti_sysbios_io_DEV_Object__count__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Object__heap__CR
#define ti_sysbios_io_DEV_Object__heap__C (*((CT__ti_sysbios_io_DEV_Object__heap*)(xdcRomConstPtr + ti_sysbios_io_DEV_Object__heap__C_offset)))
#else
#define ti_sysbios_io_DEV_Object__heap (ti_sysbios_io_DEV_Object__heap__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Object__sizeof__CR
#define ti_sysbios_io_DEV_Object__sizeof__C (*((CT__ti_sysbios_io_DEV_Object__sizeof*)(xdcRomConstPtr + ti_sysbios_io_DEV_Object__sizeof__C_offset)))
#else
#define ti_sysbios_io_DEV_Object__sizeof (ti_sysbios_io_DEV_Object__sizeof__C)
#endif
...
#ifdef ti_sysbios_io_DEV_Object__table__CR
#define ti_sysbios_io_DEV_Object__table__C (*((CT__ti_sysbios_io_DEV_Object__table*)(xdcRomConstPtr + ti_sysbios_io_DEV_Object__table__C_offset)))
#else
#define ti_sysbios_io_DEV_Object__table (ti_sysbios_io_DEV_Object__table__C)
#endif
...
#ifdef ti_sysbios_io_DEV_tableSize__CR
#define ti_sysbios_io_DEV_tableSize (*((CT__ti_sysbios_io_DEV_tableSize*)(xdcRomConstPtr + ti_sysbios_io_DEV_tableSize__C_offset)))
#else
...
/* Instance_init__E */
xdc__CODESECT(ti_sysbios_io_DEV_Instance_init__E, "ti_sysbios_io_DEV_Instance_init")
__extern xdc_Int ti_sysbios_io_DEV_Instance_init__E(ti_sysbios_io_DEV_Object *__obj, xdc_String name, xdc_Ptr fxns, const ti_sysbios_io_DEV_Params *__prms, xdc_runtime_Error_Block *__eb);

/* Instance_finalize__E */
xdc__CODESECT(ti_sysbios_io_DEV_Instance_finalize__E, "ti_sysbios_io_DEV_Instance_finalize")
__extern void ti_sysbios_io_DEV_Instance_finalize__E(ti_sysbios_io_DEV_Object *__obj, int __ec);

/* create */
xdc__CODESECT(ti_sysbios_io_DEV_create, "ti_sysbios_io_DEV_create")
__extern ti_sysbios_io_DEV_Handle ti_sysbios_io_DEV_create( xdc_String name, xdc_Ptr fxns, const ti_sysbios_io_DEV_Params *__prms, xdc_runtime_Error_Block *__eb );

/* construct */
xdc__CODESECT(ti_sysbios_io_DEV_construct, "ti_sysbios_io_DEV_construct")
__extern void ti_sysbios_io_DEV_construct( ti_sysbios_io_DEV_Struct *__obj, xdc_String name, xdc_Ptr fxns, const ti_sysbios_io_DEV_Params *__prms, xdc_runtime_Error_Block *__eb );

/* delete */
xdc__CODESECT(ti_sysbios_io_DEV_delete, "ti_sysbios_io_DEV_delete")
__extern void ti_sysbios_io_DEV_delete(ti_sysbios_io_DEV_Handle *instp);

/* destruct */
xdc__CODESECT(ti_sysbios_io_DEV_destruct, "ti_sysbios_io_DEV_destruct")
__extern void ti_sysbios_io_DEV_destruct(ti_sysbios_io_DEV_Struct *obj);

/* Handle__label__S */
xdc__CODESECT(ti_sysbios_io_DEV_Handle__label__S, "ti_sysbios_io_DEV_Handle__label__S")
__extern xdc_runtime_Types_Label *ti_sysbios_io_DEV_Handle__label__S( xdc_Ptr obj, xdc_runtime_Types_Label *lab );

/* Module__startupDone__S */
xdc__CODESECT(ti_sysbios_io_DEV_Module__startupDone__S, "ti_sysbios_io_DEV_Module__startupDone__S")
__extern xdc_Bool ti_sysbios_io_DEV_Module__startupDone__S( void );

/* Object__create__S */
xdc__CODESECT(ti_sysbios_io_DEV_Object__create__S, "ti_sysbios_io_DEV_Object__create__S")
__extern xdc_Ptr ti_sysbios_io_DEV_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );

/* Object__delete__S */
xdc__CODESECT(ti_sysbios_io_DEV_Object__delete__S, "ti_sysbios_io_DEV_Object__delete__S")
__extern xdc_Void ti_sysbios_io_DEV_Object__delete__S( xdc_Ptr instp );

/* Object__get__S */
xdc__CODESECT(ti_sysbios_io_DEV_Object__get__S, "ti_sysbios_io_DEV_Object__get__S")
__extern xdc_Ptr ti_sysbios_io_DEV_Object__get__S( xdc_Ptr oarr, xdc_Int i );

/* Object__first__S */
xdc__CODESECT(ti_sysbios_io_DEV_Object__first__S, "ti_sysbios_io_DEV_Object__first__S")
__extern xdc_Ptr ti_sysbios_io_DEV_Object__first__S( void );

/* Object__next__S */
xdc__CODESECT(ti_sysbios_io_DEV_Object__next__S, "ti_sysbios_io_DEV_Object__next__S")
__extern xdc_Ptr ti_sysbios_io_DEV_Object__next__S( xdc_Ptr obj );

/* Params__init__S */
xdc__CODESECT(ti_sysbios_io_DEV_Params__init__S, "ti_sysbios_io_DEV_Params__init__S")
__extern xdc_Void ti_sysbios_io_DEV_Params__init__S( xdc_Ptr dst, const xdc_Void *src, xdc_SizeT psz, xdc_SizeT isz );
...
static inline xdc_Bool ti_sysbios_io_DEV_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_io_DEV_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_io_DEV_Module_getMask( void ) 
{
    return ti_sysbios_io_DEV_Module__diagsMask__C != NULL ? *ti_sysbios_io_DEV_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_io_DEV_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_io_DEV_Module__diagsMask__C != NULL) {
        *ti_sysbios_io_DEV_Module__diagsMask__C = mask;
    }
}
...
{
    if (dst) {
        ti_sysbios_io_DEV_Params__init__S(dst, (const void *)src, sizeof(ti_sysbios_io_DEV_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Handle_name */
static inline xdc_String ti_sysbios_io_DEV_Handle_name(ti_sysbios_io_DEV_Handle inst);
static inline xdc_String ti_sysbios_io_DEV_Handle_name(ti_sysbios_io_DEV_Handle inst)
{
...
/* Module__state__V */
#ifndef ti_sysbios_io_DEV_Module__state__VR
extern struct ti_sysbios_io_DEV_Module_State__ ti_sysbios_io_DEV_Module__state__V;
#else
#define ti_sysbios_io_DEV_Module__state__V (*((struct ti_sysbios_io_DEV_Module_State__*)(xdcRomStatePtr + ti_sysbios_io_DEV_Module__state__V_offset)))
#endif
