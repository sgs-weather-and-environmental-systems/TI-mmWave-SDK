...
/* module */
#ifdef ti_sysbios_io_DEV_Module__state__VR
#define DEV_module ((ti_sysbios_io_DEV_Module_State *)(xdcRomStatePtr + ti_sysbios_io_DEV_Module__state__V_offset))
#define module ((ti_sysbios_io_DEV_Module_State *)(xdcRomStatePtr + ti_sysbios_io_DEV_Module__state__V_offset))
#else
...
#define Module__MID (*((CT__ti_sysbios_io_DEV_Module__id *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__id__C_offset)))
#else
...
#define Module__DGSINCL (*((CT__ti_sysbios_io_DEV_Module__diagsIncluded *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__diagsIncluded__C_offset)))
#else
...
#define Module__DGSENAB (*((CT__ti_sysbios_io_DEV_Module__diagsEnabled *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__diagsEnabled__C_offset)))
#else
...
#define Module__DGSMASK (*((CT__ti_sysbios_io_DEV_Module__diagsMask *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__diagsMask__C_offset)))
#else
...
#define Module__LOGDEF (*((CT__ti_sysbios_io_DEV_Module__loggerDefined *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerDefined__C_offset)))
#else
...
#define Module__LOGOBJ ti_sysbios_io_DEV_Module__loggerObj__R
#define Module__LOGOBJ (*((CT__ti_sysbios_io_DEV_Module__loggerObj *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerObj__C_offset)))
#else
...
#define Module__LOGFXN0 (*((CT__ti_sysbios_io_DEV_Module__loggerFxn0 *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn0__C_offset)))
#else
...
#define Module__LOGFXN1 (*((CT__ti_sysbios_io_DEV_Module__loggerFxn1 *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn1__C_offset)))
#else
...
#define Module__LOGFXN2 (*((CT__ti_sysbios_io_DEV_Module__loggerFxn2 *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn2__C_offset)))
#else
...
#define Module__LOGFXN4 (*((CT__ti_sysbios_io_DEV_Module__loggerFxn4 *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn4__C_offset)))
#else
...
#define Module__LOGFXN8 (*((CT__ti_sysbios_io_DEV_Module__loggerFxn8 *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__loggerFxn8__C_offset)))
#else
...
#define Module__G_OBJ (*((CT__ti_sysbios_io_DEV_Module__gateObj *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__gateObj__C_offset)))
#else
...
#define Module__G_PRMS (*((CT__ti_sysbios_io_DEV_Module__gatePrms *)(xdcRomConstPtr + ti_sysbios_io_DEV_Module__gatePrms__C_offset)))
#else
