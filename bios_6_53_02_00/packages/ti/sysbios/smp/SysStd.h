...
#define ti_sysbios_smp_SysStd___VERS 200
...
typedef xdc_Char __CARRAY1_ti_sysbios_smp_SysStd_LineBuffer__outbuf[256];
typedef __CARRAY1_ti_sysbios_smp_SysStd_LineBuffer__outbuf __TA_ti_sysbios_smp_SysStd_LineBuffer__outbuf;
...
typedef const ti_sysbios_smp_SysStd_LineBuffer *__CARRAY1_ti_sysbios_smp_SysStd_Module_State__lineBuffers;
...
#ifdef ti_sysbios_smp_SysStd_Module__diagsEnabled__CR
#define ti_sysbios_smp_SysStd_Module__diagsEnabled__C (*((CT__ti_sysbios_smp_SysStd_Module__diagsEnabled*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__diagsEnabled__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__diagsEnabled (ti_sysbios_smp_SysStd_Module__diagsEnabled__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__diagsIncluded__CR
#define ti_sysbios_smp_SysStd_Module__diagsIncluded__C (*((CT__ti_sysbios_smp_SysStd_Module__diagsIncluded*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__diagsIncluded__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__diagsIncluded (ti_sysbios_smp_SysStd_Module__diagsIncluded__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__diagsMask__CR
#define ti_sysbios_smp_SysStd_Module__diagsMask__C (*((CT__ti_sysbios_smp_SysStd_Module__diagsMask*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__diagsMask__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__diagsMask (ti_sysbios_smp_SysStd_Module__diagsMask__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__gateObj__CR
#define ti_sysbios_smp_SysStd_Module__gateObj__C (*((CT__ti_sysbios_smp_SysStd_Module__gateObj*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__gateObj__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__gateObj (ti_sysbios_smp_SysStd_Module__gateObj__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__gatePrms__CR
#define ti_sysbios_smp_SysStd_Module__gatePrms__C (*((CT__ti_sysbios_smp_SysStd_Module__gatePrms*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__gatePrms__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__gatePrms (ti_sysbios_smp_SysStd_Module__gatePrms__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__id__CR
#define ti_sysbios_smp_SysStd_Module__id__C (*((CT__ti_sysbios_smp_SysStd_Module__id*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__id__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__id (ti_sysbios_smp_SysStd_Module__id__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__loggerDefined__CR
#define ti_sysbios_smp_SysStd_Module__loggerDefined__C (*((CT__ti_sysbios_smp_SysStd_Module__loggerDefined*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__loggerDefined__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__loggerDefined (ti_sysbios_smp_SysStd_Module__loggerDefined__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__loggerObj__CR
#define ti_sysbios_smp_SysStd_Module__loggerObj__C (*((CT__ti_sysbios_smp_SysStd_Module__loggerObj*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__loggerObj__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__loggerObj (ti_sysbios_smp_SysStd_Module__loggerObj__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__loggerFxn0__CR
#define ti_sysbios_smp_SysStd_Module__loggerFxn0__C (*((CT__ti_sysbios_smp_SysStd_Module__loggerFxn0*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__loggerFxn0__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__loggerFxn0 (ti_sysbios_smp_SysStd_Module__loggerFxn0__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__loggerFxn1__CR
#define ti_sysbios_smp_SysStd_Module__loggerFxn1__C (*((CT__ti_sysbios_smp_SysStd_Module__loggerFxn1*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__loggerFxn1__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__loggerFxn1 (ti_sysbios_smp_SysStd_Module__loggerFxn1__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__loggerFxn2__CR
#define ti_sysbios_smp_SysStd_Module__loggerFxn2__C (*((CT__ti_sysbios_smp_SysStd_Module__loggerFxn2*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__loggerFxn2__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__loggerFxn2 (ti_sysbios_smp_SysStd_Module__loggerFxn2__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__loggerFxn4__CR
#define ti_sysbios_smp_SysStd_Module__loggerFxn4__C (*((CT__ti_sysbios_smp_SysStd_Module__loggerFxn4*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__loggerFxn4__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__loggerFxn4 (ti_sysbios_smp_SysStd_Module__loggerFxn4__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Module__loggerFxn8__CR
#define ti_sysbios_smp_SysStd_Module__loggerFxn8__C (*((CT__ti_sysbios_smp_SysStd_Module__loggerFxn8*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__loggerFxn8__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Module__loggerFxn8 (ti_sysbios_smp_SysStd_Module__loggerFxn8__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Object__count__CR
#define ti_sysbios_smp_SysStd_Object__count__C (*((CT__ti_sysbios_smp_SysStd_Object__count*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Object__count__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Object__count (ti_sysbios_smp_SysStd_Object__count__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Object__heap__CR
#define ti_sysbios_smp_SysStd_Object__heap__C (*((CT__ti_sysbios_smp_SysStd_Object__heap*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Object__heap__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Object__heap (ti_sysbios_smp_SysStd_Object__heap__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Object__sizeof__CR
#define ti_sysbios_smp_SysStd_Object__sizeof__C (*((CT__ti_sysbios_smp_SysStd_Object__sizeof*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Object__sizeof__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Object__sizeof (ti_sysbios_smp_SysStd_Object__sizeof__C)
#endif
...
#ifdef ti_sysbios_smp_SysStd_Object__table__CR
#define ti_sysbios_smp_SysStd_Object__table__C (*((CT__ti_sysbios_smp_SysStd_Object__table*)(xdcRomConstPtr + ti_sysbios_smp_SysStd_Object__table__C_offset)))
#else
#define ti_sysbios_smp_SysStd_Object__table (ti_sysbios_smp_SysStd_Object__table__C)
#endif
...
#ifndef ti_sysbios_smp_SysStd_Module__FXNS__CR

/* Module__FXNS__C */
__extern const ti_sysbios_smp_SysStd_Fxns__ ti_sysbios_smp_SysStd_Module__FXNS__C;
#else
#define ti_sysbios_smp_SysStd_Module__FXNS__C (*(xdcRomConstPtr + ti_sysbios_smp_SysStd_Module__FXNS__C_offset))
#endif
...
xdc__CODESECT(ti_sysbios_smp_SysStd_Module__startupDone__S, "ti_sysbios_smp_SysStd_Module__startupDone__S")
...
static inline xdc_Bool ti_sysbios_smp_SysStd_Module_hasMask(void) 
{
    return (xdc_Bool)(ti_sysbios_smp_SysStd_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 ti_sysbios_smp_SysStd_Module_getMask( void ) 
{
    return ti_sysbios_smp_SysStd_Module__diagsMask__C != NULL ? *ti_sysbios_smp_SysStd_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_smp_SysStd_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_smp_SysStd_Module__diagsMask__C != NULL) {
        *ti_sysbios_smp_SysStd_Module__diagsMask__C = mask;
    }
}
...
/* Module__state__V */
#ifndef ti_sysbios_smp_SysStd_Module__state__VR
extern struct ti_sysbios_smp_SysStd_Module_State__ ti_sysbios_smp_SysStd_Module__state__V;
#else
#define ti_sysbios_smp_SysStd_Module__state__V (*((struct ti_sysbios_smp_SysStd_Module_State__*)(xdcRomStatePtr + ti_sysbios_smp_SysStd_Module__state__V_offset)))
#endif
