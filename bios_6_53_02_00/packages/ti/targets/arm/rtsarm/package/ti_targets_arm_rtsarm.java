...
public class ti_targets_arm_rtsarm
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/ti.targets.arm.rtsarm.aem0',\n");
            sb.append("'lib/boot.aem0',\n");
            sb.append("'lib/auto_init.aem0',\n");
            ...
            sb.append("'lib/ti.targets.arm.rtsarm.aer5f',\n");
            sb.append("'lib/boot.aer5f',\n");
            sb.append("'lib/auto_init.aer5f',\n");
            sb.append("'lib/ti.targets.arm.rtsarm.aer4f',\n");
            sb.append("'lib/boot.aer4f',\n");
            sb.append("'lib/auto_init.aer4f',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/ti.targets.arm.rtsarm.aem0', {target: 'ti.targets.arm.elf.M0', suffix: 'em0'}],\n");
            sb.append("['lib/boot.aem0', {target: 'ti.targets.arm.elf.M0', suffix: 'em0'}],\n");
            sb.append("['lib/auto_init.aem0', {target: 'ti.targets.arm.elf.M0', suffix: 'em0'}],\n");
            ...
            sb.append("['lib/ti.targets.arm.rtsarm.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
            sb.append("['lib/boot.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
            sb.append("['lib/auto_init.aer5f', {target: 'ti.targets.arm.elf.R5F', suffix: 'er5f'}],\n");
            sb.append("['lib/ti.targets.arm.rtsarm.aer4f', {target: 'ti.targets.arm.elf.R4F', suffix: 'er4f'}],\n");
            sb.append("['lib/boot.aer4f', {target: 'ti.targets.arm.elf.R4F', suffix: 'er4f'}],\n");
            sb.append("['lib/auto_init.aer4f', {target: 'ti.targets.arm.elf.R4F', suffix: 'er4f'}],\n");
