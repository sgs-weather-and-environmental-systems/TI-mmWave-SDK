...
public class ti_platforms_simVayu
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        om.bind("ti.platforms.simVayu.Platform.Object", new Proto.Str(po, true));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.platforms.simVayu$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.platforms.simVayu$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.platforms.simVayu$$stat$root'];\n");
        sb.append("}\n");
