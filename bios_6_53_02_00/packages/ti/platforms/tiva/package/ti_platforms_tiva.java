...
public class ti_platforms_tiva
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        om.bind("ti.platforms.tiva.Platform.Object", new Proto.Str(po, true));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.platforms.tiva$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.platforms.tiva$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.platforms.tiva$$stat$root'];\n");
        sb.append("}\n");
