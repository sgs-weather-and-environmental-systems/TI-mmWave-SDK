...
public class ti_platforms_evmTNETV2685
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        om.bind("ti.platforms.evmTNETV2685.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.evmTNETV2685.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.evmTNETV2685.Platform.Module", "ti.platforms.evmTNETV2685"), om.findStrict("ti.platforms.evmTNETV2685.Platform.Instance", "ti.platforms.evmTNETV2685"), 2, 1, false));
                fxn.addArg(0, "name", $$T_Str, $$UNDEF);
                fxn.addArg(1, "__params", (Proto)om.findStrict("ti.platforms.evmTNETV2685.Platform.Params", "ti.platforms.evmTNETV2685"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$evmTNETV2685$Platform$$create = function( name, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.evmTNETV2685.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.evmTNETV2685.Platform.Module", "ti.platforms.evmTNETV2685"), null, 3, 1, false));
        ...
        sb = new StringBuilder();
        sb.append("ti$platforms$evmTNETV2685$Platform$$construct = function( __obj, name, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.evmTNETV2685.Platform'];\n");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.platforms.evmTNETV2685$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.platforms.evmTNETV2685$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.platforms.evmTNETV2685$$stat$root'];\n");
        sb.append("}\n");
