...
public class ti_platforms_simArctic
{
    ...
    void Platform$$OBJECTS()
    {
        ...
        om.bind("ti.platforms.simArctic.Platform.Object", new Proto.Str(po, true));
    ...
    void Platform$$CREATES()
    {
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.simArctic.Platform$$create", new Proto.Fxn(om.findStrict("ti.platforms.simArctic.Platform.Module", "ti.platforms.simArctic"), om.findStrict("ti.platforms.simArctic.Platform.Instance", "ti.platforms.simArctic"), 2, 1, false));
                fxn.addArg(0, "name", $$T_Str, $$UNDEF);
                fxn.addArg(1, "__params", (Proto)om.findStrict("ti.platforms.simArctic.Platform.Params", "ti.platforms.simArctic"), Global.newObject());
        sb = new StringBuilder();
        sb.append("ti$platforms$simArctic$Platform$$create = function( name, __params ) {\n");
        ...
        fxn = (Proto.Fxn)om.bind("ti.platforms.simArctic.Platform$$construct", new Proto.Fxn(om.findStrict("ti.platforms.simArctic.Platform.Module", "ti.platforms.simArctic"), null, 3, 1, false));
        ...
        sb = new StringBuilder();
        sb.append("ti$platforms$simArctic$Platform$$construct = function( __obj, name, __params ) {\n");
            sb.append("var __mod = xdc.om['ti.platforms.simArctic.Platform'];\n");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.platforms.simArctic$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.platforms.simArctic$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.platforms.simArctic$$stat$root'];\n");
        sb.append("}\n");
