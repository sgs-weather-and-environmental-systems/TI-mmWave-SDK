...
{
    return (xdc_Bool)(iar_targets_arm_rts_Settings_Module__diagsMask__C != NULL);
}

/* Module_getMask */
static inline xdc_Bits16 iar_targets_arm_rts_Settings_Module_getMask( void ) 
{
    return iar_targets_arm_rts_Settings_Module__diagsMask__C != NULL ? *iar_targets_arm_rts_Settings_Module__diagsMask__C : (xdc_Bits16)0;
}

/* Module_setMask */
static inline xdc_Void iar_targets_arm_rts_Settings_Module_setMask( xdc_Bits16 mask ) 
{
    if (iar_targets_arm_rts_Settings_Module__diagsMask__C != NULL) {
