...
#*******************************************************************************
#* FILE NAME: lib/mathlib.ae674.mk
#*
...
OBJDIR = ./package/lib/lib/mathlibae674
...
KERNELC674CFLAGS =  -c -k -mw --strip_coff_underscore -o3 --symdebug:none --mem_model:data=far -dOVERRIDE_RTS=0 
...
$(KERNELC674COBJS):lib\mathlib.ae674.mk
lib\mathlib.ae674.mk:
...
# FLAGS for the kernelc674 Files
KERNELC674ASMFLAGS =  -ea.s -c -k --strip_coff_underscore --mem_model:data=far -dOVERRIDE_RTS=0 
...
#Create Empty rule for dependency
$(KERNELC674ASMOBJS):lib\mathlib.ae674.mk
lib\mathlib.ae674.mk:
...
lib/mathlib.ae674 : $(KERNELC674COBJS) $(KERNELC674ASMOBJS)
	@echo archiving $? into $@ ...
	$(ARIN) $@ $?
