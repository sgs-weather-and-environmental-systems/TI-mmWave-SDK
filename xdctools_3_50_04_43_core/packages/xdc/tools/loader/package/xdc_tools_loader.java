...
public class xdc_tools_loader
{
    ...
    void Main$$OBJECTS()
    {
        ...
        om.bind("xdc.tools.loader.Main.Object", new Proto.Str(po, true));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('xdc.tools.loader$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['xdc.tools.loader$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['xdc.tools.loader$$stat$root'];\n");
        sb.append("}\n");
