...
public class xdc_tools_path
{
    ...
    void Main$$OBJECTS()
    {
        ...
        om.bind("xdc.tools.path.Main.Object", new Proto.Str(po, true));
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('xdc.tools.path$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['xdc.tools.path$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['xdc.tools.path$$stat$root'];\n");
        sb.append("}\n");
