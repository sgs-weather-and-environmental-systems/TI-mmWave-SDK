...
struct xdc_runtime_HeapStd_Fxns__ {
    ...
    xdc_Ptr (*alloc)(xdc_runtime_HeapStd_Handle __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb);
    xdc_Void (*free)(xdc_runtime_HeapStd_Handle __inst, xdc_Ptr block, xdc_SizeT size);
    xdc_Bool (*isBlocking)(xdc_runtime_HeapStd_Handle __inst);
    xdc_Void (*getStats)(xdc_runtime_HeapStd_Handle __inst, xdc_runtime_Memory_Stats* stats);
...
__extern xdc_Int xdc_runtime_HeapStd_Instance_init__E(xdc_runtime_HeapStd_Object *__obj, const xdc_runtime_HeapStd_Params *__prms, xdc_runtime_Error_Block *__eb);
...
__extern xdc_Ptr xdc_runtime_HeapStd_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline xdc_runtime_HeapStd_Handle xdc_runtime_HeapStd_Handle_downCast(xdc_runtime_IHeap_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&xdc_runtime_HeapStd_Module__FXNS__C ? (xdc_runtime_HeapStd_Handle)i : (xdc_runtime_HeapStd_Handle)0;
}
...
static inline xdc_Bool xdc_runtime_HeapStd_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_HeapStd_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_HeapStd_Module_getMask( void ) 
{
    return xdc_runtime_HeapStd_Module__diagsMask__C != NULL ? *xdc_runtime_HeapStd_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_HeapStd_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_HeapStd_Module__diagsMask__C != NULL) {
