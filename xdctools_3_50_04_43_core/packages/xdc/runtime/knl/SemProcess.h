...
struct xdc_runtime_knl_SemProcess_Fxns__ {
    ...
    xdc_Int (*pend)(xdc_runtime_knl_SemProcess_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
    xdc_Bool (*post)(xdc_runtime_knl_SemProcess_Handle __inst, xdc_runtime_Error_Block* eb);
...
__extern xdc_Int xdc_runtime_knl_SemProcess_Instance_init__E(xdc_runtime_knl_SemProcess_Object *__obj, xdc_Int count, xdc_UInt32 key, const xdc_runtime_knl_SemProcess_Params *__prms, xdc_runtime_Error_Block *__eb);

/* Instance_finalize__E */
xdc__CODESECT(xdc_runtime_knl_SemProcess_Instance_finalize__E, "xdc_runtime_knl_SemProcess_Instance_finalize")
__extern void xdc_runtime_knl_SemProcess_Instance_finalize__E(xdc_runtime_knl_SemProcess_Object *__obj, int __ec);
...
__extern xdc_Ptr xdc_runtime_knl_SemProcess_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline xdc_runtime_knl_SemProcess_Handle xdc_runtime_knl_SemProcess_Handle_downCast(xdc_runtime_knl_ISemaphore_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&xdc_runtime_knl_SemProcess_Module__FXNS__C ? (xdc_runtime_knl_SemProcess_Handle)i : (xdc_runtime_knl_SemProcess_Handle)0;
}
...
static inline xdc_Bool xdc_runtime_knl_SemProcess_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_knl_SemProcess_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_knl_SemProcess_Module_getMask( void ) 
{
    return xdc_runtime_knl_SemProcess_Module__diagsMask__C != NULL ? *xdc_runtime_knl_SemProcess_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_knl_SemProcess_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_knl_SemProcess_Module__diagsMask__C != NULL) {
