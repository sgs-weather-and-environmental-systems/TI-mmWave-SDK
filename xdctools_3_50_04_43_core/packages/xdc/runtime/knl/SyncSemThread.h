...
struct xdc_runtime_knl_SyncSemThread_Fxns__ {
    ...
    xdc_Bool (*query)(xdc_runtime_knl_SyncSemThread_Handle __inst, xdc_Int qual);
    xdc_Void (*signal)(xdc_runtime_knl_SyncSemThread_Handle __inst);
    xdc_Int (*wait)(xdc_runtime_knl_SyncSemThread_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
...
__extern xdc_Int xdc_runtime_knl_SyncSemThread_Instance_init__E(xdc_runtime_knl_SyncSemThread_Object *__obj, const xdc_runtime_knl_SyncSemThread_Params *__prms, xdc_runtime_Error_Block *__eb);

/* Instance_finalize__E */
xdc__CODESECT(xdc_runtime_knl_SyncSemThread_Instance_finalize__E, "xdc_runtime_knl_SyncSemThread_Instance_finalize")
__extern void xdc_runtime_knl_SyncSemThread_Instance_finalize__E(xdc_runtime_knl_SyncSemThread_Object *__obj, int __ec);
...
__extern xdc_Ptr xdc_runtime_knl_SyncSemThread_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline xdc_runtime_knl_SyncSemThread_Handle xdc_runtime_knl_SyncSemThread_Handle_downCast(xdc_runtime_knl_ISync_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&xdc_runtime_knl_SyncSemThread_Module__FXNS__C ? (xdc_runtime_knl_SyncSemThread_Handle)i : (xdc_runtime_knl_SyncSemThread_Handle)0;
}
...
static inline xdc_Bool xdc_runtime_knl_SyncSemThread_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_knl_SyncSemThread_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_knl_SyncSemThread_Module_getMask( void ) 
{
    return xdc_runtime_knl_SyncSemThread_Module__diagsMask__C != NULL ? *xdc_runtime_knl_SyncSemThread_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_knl_SyncSemThread_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_knl_SyncSemThread_Module__diagsMask__C != NULL) {
