...
/* RunFxn */
typedef xdc_Void (*xdc_runtime_knl_IThreadSupport_RunFxn)(xdc_IArg __arg1);
...
struct xdc_runtime_knl_IThreadSupport_Fxns__ {
    ...
    xdc_Bool (*join)(void* __inst, xdc_runtime_Error_Block* eb);
    xdc_runtime_knl_IThreadSupport_Priority (*getPriority)(void* __inst, xdc_runtime_Error_Block* eb);
    xdc_Bool (*setPriority)(void* __inst, xdc_runtime_knl_IThreadSupport_Priority newPri, xdc_runtime_Error_Block* eb);
    xdc_Int (*getOsPriority)(void* __inst, xdc_runtime_Error_Block* eb);
    xdc_Bool (*setOsPriority)(void* __inst, xdc_Int newPri, xdc_runtime_Error_Block* eb);
    xdc_Ptr (*getOsHandle)(void* __inst);
    xdc_Ptr (*getTls)(void* __inst);
    xdc_Void (*setTls)(void* __inst, xdc_Ptr tls);
    xdc_Bool (*stat)(void* __inst, xdc_runtime_knl_IThreadSupport_Stat* buf, xdc_runtime_Error_Block* eb);
...
__extern xdc_runtime_knl_IThreadSupport_Handle xdc_runtime_knl_IThreadSupport_create(xdc_runtime_knl_IThreadSupport_Module __mod, xdc_runtime_knl_IThreadSupport_RunFxn fxn, const xdc_runtime_knl_IThreadSupport_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_knl_IThreadSupport_delete, "xdc_runtime_knl_IThreadSupport_delete")
__extern xdc_Void xdc_runtime_knl_IThreadSupport_delete(xdc_runtime_knl_IThreadSupport_Handle *__inst);
...
/* join_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_IThreadSupport_join_FxnT)(xdc_Void *__inst, xdc_runtime_Error_Block* eb);
...
typedef xdc_runtime_knl_IThreadSupport_Priority (*xdc_runtime_knl_IThreadSupport_getPriority_FxnT)(xdc_Void *__inst, xdc_runtime_Error_Block* eb);
...
typedef xdc_Bool (*xdc_runtime_knl_IThreadSupport_setPriority_FxnT)(xdc_Void *__inst, xdc_runtime_knl_IThreadSupport_Priority newPri, xdc_runtime_Error_Block* eb);
...
typedef xdc_Int (*xdc_runtime_knl_IThreadSupport_getOsPriority_FxnT)(xdc_Void *__inst, xdc_runtime_Error_Block* eb);
...
typedef xdc_Bool (*xdc_runtime_knl_IThreadSupport_setOsPriority_FxnT)(xdc_Void *__inst, xdc_Int newPri, xdc_runtime_Error_Block* eb);
...
typedef xdc_Ptr (*xdc_runtime_knl_IThreadSupport_getOsHandle_FxnT)(xdc_Void *__inst);
...
/* getTls_{FxnT,fxnP} */
typedef xdc_Ptr (*xdc_runtime_knl_IThreadSupport_getTls_FxnT)(xdc_Void *__inst);
...
/* setTls_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_IThreadSupport_setTls_FxnT)(xdc_Void *__inst, xdc_Ptr tls);
...
/* stat_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_IThreadSupport_stat_FxnT)(xdc_Void *__inst, xdc_runtime_knl_IThreadSupport_Stat* buf, xdc_runtime_Error_Block* eb);
