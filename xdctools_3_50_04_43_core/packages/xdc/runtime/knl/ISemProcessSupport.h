...
struct xdc_runtime_knl_ISemProcessSupport_Fxns__ {
    ...
    xdc_Int (*pend)(void* __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
    xdc_Bool (*post)(void* __inst, xdc_runtime_Error_Block* eb);
...
__extern xdc_runtime_knl_ISemProcessSupport_Handle xdc_runtime_knl_ISemProcessSupport_create(xdc_runtime_knl_ISemProcessSupport_Module __mod, xdc_Int count, xdc_Int key, const xdc_runtime_knl_ISemProcessSupport_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_knl_ISemProcessSupport_delete, "xdc_runtime_knl_ISemProcessSupport_delete")
__extern xdc_Void xdc_runtime_knl_ISemProcessSupport_delete(xdc_runtime_knl_ISemProcessSupport_Handle *__inst);
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_ISemProcessSupport_pend_FxnT)(xdc_Void *__inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
...
/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_ISemProcessSupport_post_FxnT)(xdc_Void *__inst, xdc_runtime_Error_Block* eb);
