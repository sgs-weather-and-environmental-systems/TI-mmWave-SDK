...
struct xdc_runtime_knl_ISync_Fxns__ {
    ...
    xdc_Bool (*query)(void* __inst, xdc_Int qual);
    xdc_Void (*signal)(void* __inst);
    xdc_Int (*wait)(void* __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
...
__extern xdc_runtime_knl_ISync_Handle xdc_runtime_knl_ISync_create(xdc_runtime_knl_ISync_Module __mod, const xdc_runtime_knl_ISync_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_knl_ISync_delete, "xdc_runtime_knl_ISync_delete")
__extern xdc_Void xdc_runtime_knl_ISync_delete(xdc_runtime_knl_ISync_Handle *__inst);
...
/* query_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_ISync_query_FxnT)(xdc_Void *__inst, xdc_Int qual);
...
/* signal_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_ISync_signal_FxnT)(xdc_Void *__inst);
...
/* wait_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_ISync_wait_FxnT)(xdc_Void *__inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
