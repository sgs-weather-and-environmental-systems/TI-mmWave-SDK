...
__extern xdc_runtime_knl_IGateThreadSupport_Handle xdc_runtime_knl_IGateThreadSupport_create(xdc_runtime_knl_IGateThreadSupport_Module __mod, const xdc_runtime_knl_IGateThreadSupport_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_knl_IGateThreadSupport_delete, "xdc_runtime_knl_IGateThreadSupport_delete")
__extern xdc_Void xdc_runtime_knl_IGateThreadSupport_delete(xdc_runtime_knl_IGateThreadSupport_Handle *__inst);
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*xdc_runtime_knl_IGateThreadSupport_enter_FxnT)(xdc_Void *__inst);
...
/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_IGateThreadSupport_leave_FxnT)(xdc_Void *__inst, xdc_IArg key);
