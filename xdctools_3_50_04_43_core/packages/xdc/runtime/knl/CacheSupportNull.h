...
static inline xdc_Bool xdc_runtime_knl_CacheSupportNull_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_knl_CacheSupportNull_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_knl_CacheSupportNull_Module_getMask( void ) 
{
    return xdc_runtime_knl_CacheSupportNull_Module__diagsMask__C != NULL ? *xdc_runtime_knl_CacheSupportNull_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_knl_CacheSupportNull_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_knl_CacheSupportNull_Module__diagsMask__C != NULL) {
