...
struct xdc_runtime_knl_GateProcess_Fxns__ {
    ...
    xdc_IArg (*enter)(xdc_runtime_knl_GateProcess_Handle __inst);
    xdc_Void (*leave)(xdc_runtime_knl_GateProcess_Handle __inst, xdc_IArg key);
...
__extern xdc_Int xdc_runtime_knl_GateProcess_Instance_init__E(xdc_runtime_knl_GateProcess_Object *__obj, const xdc_runtime_knl_GateProcess_Params *__prms, xdc_runtime_Error_Block *__eb);

/* Instance_finalize__E */
xdc__CODESECT(xdc_runtime_knl_GateProcess_Instance_finalize__E, "xdc_runtime_knl_GateProcess_Instance_finalize")
__extern void xdc_runtime_knl_GateProcess_Instance_finalize__E(xdc_runtime_knl_GateProcess_Object *__obj, int __ec);
...
__extern xdc_Ptr xdc_runtime_knl_GateProcess_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline xdc_runtime_knl_GateProcess_Handle xdc_runtime_knl_GateProcess_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&xdc_runtime_knl_GateProcess_Module__FXNS__C ? (xdc_runtime_knl_GateProcess_Handle)i : (xdc_runtime_knl_GateProcess_Handle)0;
}
...
static inline xdc_Bool xdc_runtime_knl_GateProcess_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_knl_GateProcess_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_knl_GateProcess_Module_getMask( void ) 
{
    return xdc_runtime_knl_GateProcess_Module__diagsMask__C != NULL ? *xdc_runtime_knl_GateProcess_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_knl_GateProcess_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_knl_GateProcess_Module__diagsMask__C != NULL) {
