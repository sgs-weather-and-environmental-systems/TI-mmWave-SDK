...
__extern xdc_runtime_knl_ISemThreadSupport_Handle xdc_runtime_knl_ISemThreadSupport_create(xdc_runtime_knl_ISemThreadSupport_Module __mod, xdc_Int count, const xdc_runtime_knl_ISemThreadSupport_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_knl_ISemThreadSupport_delete, "xdc_runtime_knl_ISemThreadSupport_delete")
__extern xdc_Void xdc_runtime_knl_ISemThreadSupport_delete(xdc_runtime_knl_ISemThreadSupport_Handle *__inst);
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_ISemThreadSupport_pend_FxnT)(xdc_Void *__inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
...
/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_ISemThreadSupport_post_FxnT)(xdc_Void *__inst, xdc_runtime_Error_Block* eb);
