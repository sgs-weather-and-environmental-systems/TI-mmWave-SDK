...
__extern xdc_runtime_knl_ISemaphore_Handle xdc_runtime_knl_ISemaphore_create(xdc_runtime_knl_ISemaphore_Module __mod, const xdc_runtime_knl_ISemaphore_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_knl_ISemaphore_delete, "xdc_runtime_knl_ISemaphore_delete")
__extern xdc_Void xdc_runtime_knl_ISemaphore_delete(xdc_runtime_knl_ISemaphore_Handle *__inst);
...
/* pend_{FxnT,fxnP} */
typedef xdc_Int (*xdc_runtime_knl_ISemaphore_pend_FxnT)(xdc_Void *__inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
...
/* post_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_knl_ISemaphore_post_FxnT)(xdc_Void *__inst, xdc_runtime_Error_Block* eb);
