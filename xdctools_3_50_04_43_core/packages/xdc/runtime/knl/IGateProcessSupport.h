...
struct xdc_runtime_knl_IGateProcessSupport_Fxns__ {
    ...
    xdc_IArg (*enter)(void* __inst);
    xdc_Void (*leave)(void* __inst, xdc_IArg key);
    xdc_Int (*getReferenceCount)(void* __inst, xdc_runtime_Error_Block* err);
...
__extern xdc_runtime_knl_IGateProcessSupport_Handle xdc_runtime_knl_IGateProcessSupport_create(xdc_runtime_knl_IGateProcessSupport_Module __mod, const xdc_runtime_knl_IGateProcessSupport_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_knl_IGateProcessSupport_delete, "xdc_runtime_knl_IGateProcessSupport_delete")
__extern xdc_Void xdc_runtime_knl_IGateProcessSupport_delete(xdc_runtime_knl_IGateProcessSupport_Handle *__inst);
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*xdc_runtime_knl_IGateProcessSupport_enter_FxnT)(xdc_Void *__inst);
...
/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_knl_IGateProcessSupport_leave_FxnT)(xdc_Void *__inst, xdc_IArg key);
...
typedef xdc_Int (*xdc_runtime_knl_IGateProcessSupport_getReferenceCount_FxnT)(xdc_Void *__inst, xdc_runtime_Error_Block* err);
