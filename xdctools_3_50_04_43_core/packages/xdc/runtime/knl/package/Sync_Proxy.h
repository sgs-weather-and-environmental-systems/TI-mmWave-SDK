...
struct xdc_runtime_knl_Sync_Proxy_Fxns__ {
    ...
    xdc_Bool (*query)(xdc_runtime_knl_Sync_Proxy_Handle __inst, xdc_Int qual);
    xdc_Void (*signal)(xdc_runtime_knl_Sync_Proxy_Handle __inst);
    xdc_Int (*wait)(xdc_runtime_knl_Sync_Proxy_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
...
static inline xdc_runtime_knl_Sync_Proxy_Handle xdc_runtime_knl_Sync_Proxy_Handle_downCast(xdc_runtime_knl_ISync_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)xdc_runtime_knl_Sync_Proxy_Proxy__delegate__S() ? (xdc_runtime_knl_Sync_Proxy_Handle)i : (xdc_runtime_knl_Sync_Proxy_Handle)0;
}
