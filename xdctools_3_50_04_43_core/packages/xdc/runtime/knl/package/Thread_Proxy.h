...
struct xdc_runtime_knl_Thread_Proxy_Fxns__ {
    ...
    xdc_Bool (*join)(xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_Error_Block* eb);
    xdc_runtime_knl_IThreadSupport_Priority (*getPriority)(xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_Error_Block* eb);
    xdc_Bool (*setPriority)(xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_knl_IThreadSupport_Priority newPri, xdc_runtime_Error_Block* eb);
    xdc_Int (*getOsPriority)(xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_Error_Block* eb);
    xdc_Bool (*setOsPriority)(xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_Int newPri, xdc_runtime_Error_Block* eb);
    xdc_Ptr (*getOsHandle)(xdc_runtime_knl_Thread_Proxy_Handle __inst);
    xdc_Ptr (*getTls)(xdc_runtime_knl_Thread_Proxy_Handle __inst);
    xdc_Void (*setTls)(xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_Ptr tls);
    xdc_Bool (*stat)(xdc_runtime_knl_Thread_Proxy_Handle __inst, xdc_runtime_knl_IThreadSupport_Stat* buf, xdc_runtime_Error_Block* eb);
...
static inline xdc_runtime_knl_Thread_Proxy_Handle xdc_runtime_knl_Thread_Proxy_Handle_downCast(xdc_runtime_knl_IThreadSupport_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)xdc_runtime_knl_Thread_Proxy_Proxy__delegate__S() ? (xdc_runtime_knl_Thread_Proxy_Handle)i : (xdc_runtime_knl_Thread_Proxy_Handle)0;
}
