...
struct xdc_runtime_knl_SyncNull_Fxns__ {
    ...
    xdc_Bool (*query)(xdc_runtime_knl_SyncNull_Handle __inst, xdc_Int qual);
    xdc_Void (*signal)(xdc_runtime_knl_SyncNull_Handle __inst);
    xdc_Int (*wait)(xdc_runtime_knl_SyncNull_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
...
__extern xdc_Void xdc_runtime_knl_SyncNull_Instance_init__E(xdc_runtime_knl_SyncNull_Object *__obj, const xdc_runtime_knl_SyncNull_Params *__prms);
...
__extern xdc_Ptr xdc_runtime_knl_SyncNull_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline xdc_runtime_knl_SyncNull_Handle xdc_runtime_knl_SyncNull_Handle_downCast(xdc_runtime_knl_ISync_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&xdc_runtime_knl_SyncNull_Module__FXNS__C ? (xdc_runtime_knl_SyncNull_Handle)i : (xdc_runtime_knl_SyncNull_Handle)0;
}
...
static inline xdc_Bool xdc_runtime_knl_SyncNull_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_knl_SyncNull_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_knl_SyncNull_Module_getMask( void ) 
{
    return xdc_runtime_knl_SyncNull_Module__diagsMask__C != NULL ? *xdc_runtime_knl_SyncNull_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_knl_SyncNull_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_knl_SyncNull_Module__diagsMask__C != NULL) {
