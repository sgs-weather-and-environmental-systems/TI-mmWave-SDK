...
/* RunFxn */
typedef xdc_Void (*xdc_runtime_knl_Thread_RunFxn)(xdc_IArg __arg1);
...
__extern xdc_Int xdc_runtime_knl_Thread_Instance_init__E(xdc_runtime_knl_Thread_Object *__obj, xdc_runtime_knl_Thread_RunFxn fxn, const xdc_runtime_knl_Thread_Params *__prms, xdc_runtime_Error_Block *__eb);

/* Instance_finalize__E */
xdc__CODESECT(xdc_runtime_knl_Thread_Instance_finalize__E, "xdc_runtime_knl_Thread_Instance_finalize")
__extern void xdc_runtime_knl_Thread_Instance_finalize__E(xdc_runtime_knl_Thread_Object *__obj, int __ec);
...
__extern xdc_Ptr xdc_runtime_knl_Thread_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline xdc_Bool xdc_runtime_knl_Thread_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_knl_Thread_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_knl_Thread_Module_getMask( void ) 
{
    return xdc_runtime_knl_Thread_Module__diagsMask__C != NULL ? *xdc_runtime_knl_Thread_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_knl_Thread_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_knl_Thread_Module__diagsMask__C != NULL) {
