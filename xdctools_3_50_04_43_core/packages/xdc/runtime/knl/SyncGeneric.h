...
/* SignalFunc */
typedef xdc_Void (*xdc_runtime_knl_SyncGeneric_SignalFunc)(xdc_UArg __arg1);

/* WaitFunc */
typedef xdc_Bool (*xdc_runtime_knl_SyncGeneric_WaitFunc)(xdc_UArg __arg1, xdc_UInt __arg2);

/* QueryFunc */
typedef xdc_Bool (*xdc_runtime_knl_SyncGeneric_QueryFunc)(xdc_Int __arg1);
...
struct xdc_runtime_knl_SyncGeneric_Fxns__ {
    ...
    xdc_Bool (*query)(xdc_runtime_knl_SyncGeneric_Handle __inst, xdc_Int qual);
    xdc_Void (*signal)(xdc_runtime_knl_SyncGeneric_Handle __inst);
    xdc_Int (*wait)(xdc_runtime_knl_SyncGeneric_Handle __inst, xdc_UInt timeout, xdc_runtime_Error_Block* eb);
...
__extern xdc_Void xdc_runtime_knl_SyncGeneric_Instance_init__E(xdc_runtime_knl_SyncGeneric_Object *__obj, const xdc_runtime_knl_SyncGeneric_Params *__prms);
...
__extern xdc_Ptr xdc_runtime_knl_SyncGeneric_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline xdc_runtime_knl_SyncGeneric_Handle xdc_runtime_knl_SyncGeneric_Handle_downCast(xdc_runtime_knl_ISync_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&xdc_runtime_knl_SyncGeneric_Module__FXNS__C ? (xdc_runtime_knl_SyncGeneric_Handle)i : (xdc_runtime_knl_SyncGeneric_Handle)0;
}
...
static inline xdc_Bool xdc_runtime_knl_SyncGeneric_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_knl_SyncGeneric_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_knl_SyncGeneric_Module_getMask( void ) 
{
    return xdc_runtime_knl_SyncGeneric_Module__diagsMask__C != NULL ? *xdc_runtime_knl_SyncGeneric_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_knl_SyncGeneric_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_knl_SyncGeneric_Module__diagsMask__C != NULL) {
