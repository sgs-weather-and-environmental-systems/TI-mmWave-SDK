...
struct xdc_runtime_Memory_HeapProxy_Fxns__ {
    ...
    xdc_Ptr (*alloc)(xdc_runtime_Memory_HeapProxy_Handle __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb);
    xdc_Void (*free)(xdc_runtime_Memory_HeapProxy_Handle __inst, xdc_Ptr block, xdc_SizeT size);
    xdc_Bool (*isBlocking)(xdc_runtime_Memory_HeapProxy_Handle __inst);
    xdc_Void (*getStats)(xdc_runtime_Memory_HeapProxy_Handle __inst, xdc_runtime_Memory_Stats* stats);
