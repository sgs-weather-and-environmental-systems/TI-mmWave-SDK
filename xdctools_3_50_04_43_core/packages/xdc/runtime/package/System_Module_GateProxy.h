...
struct xdc_runtime_System_Module_GateProxy_Fxns__ {
    ...
    xdc_IArg (*enter)(xdc_runtime_System_Module_GateProxy_Handle __inst);
    xdc_Void (*leave)(xdc_runtime_System_Module_GateProxy_Handle __inst, xdc_IArg key);
...
static inline xdc_runtime_System_Module_GateProxy_Handle xdc_runtime_System_Module_GateProxy_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)xdc_runtime_System_Module_GateProxy_Proxy__delegate__S() ? (xdc_runtime_System_Module_GateProxy_Handle)i : (xdc_runtime_System_Module_GateProxy_Handle)0;
}
