...
__extern xdc_runtime_IInstance_Handle xdc_runtime_IInstance_create(xdc_runtime_IInstance_Module __mod, const xdc_runtime_IInstance_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_IInstance_delete, "xdc_runtime_IInstance_delete")
__extern xdc_Void xdc_runtime_IInstance_delete(xdc_runtime_IInstance_Handle *__inst);
