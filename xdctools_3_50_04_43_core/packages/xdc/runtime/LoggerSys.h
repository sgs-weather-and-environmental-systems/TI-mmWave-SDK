...
struct xdc_runtime_LoggerSys_Fxns__ {
    ...
    xdc_Bool (*enable)(xdc_runtime_LoggerSys_Handle __inst);
    xdc_Bool (*disable)(xdc_runtime_LoggerSys_Handle __inst);
    xdc_Void (*write0)(xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid);
    xdc_Void (*write1)(xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1);
    xdc_Void (*write2)(xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2);
    xdc_Void (*write4)(xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4);
    xdc_Void (*write8)(xdc_runtime_LoggerSys_Handle __inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8);
...
__extern xdc_Void xdc_runtime_LoggerSys_Instance_init__E(xdc_runtime_LoggerSys_Object *__obj, const xdc_runtime_LoggerSys_Params *__prms);
...
__extern xdc_Ptr xdc_runtime_LoggerSys_Object__create__S( xdc_CPtr __aa, const xdc_UChar *__pa, xdc_SizeT __psz, xdc_runtime_Error_Block *__eb );
...
static inline xdc_runtime_LoggerSys_Handle xdc_runtime_LoggerSys_Handle_downCast(xdc_runtime_ILogger_Handle i)
{
    ...
    return (const void*)i2->__fxns == (const void*)&xdc_runtime_LoggerSys_Module__FXNS__C ? (xdc_runtime_LoggerSys_Handle)i : (xdc_runtime_LoggerSys_Handle)0;
}
...
static inline xdc_Bool xdc_runtime_LoggerSys_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_LoggerSys_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_LoggerSys_Module_getMask( void ) 
{
    return xdc_runtime_LoggerSys_Module__diagsMask__C != NULL ? *xdc_runtime_LoggerSys_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_LoggerSys_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_LoggerSys_Module__diagsMask__C != NULL) {
