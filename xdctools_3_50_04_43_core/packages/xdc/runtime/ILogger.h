...
__extern xdc_runtime_ILogger_Handle xdc_runtime_ILogger_create(xdc_runtime_ILogger_Module __mod, const xdc_runtime_ILogger_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_ILogger_delete, "xdc_runtime_ILogger_delete")
__extern xdc_Void xdc_runtime_ILogger_delete(xdc_runtime_ILogger_Handle *__inst);
...
/* enable_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_ILogger_enable_FxnT)(xdc_Void *__inst);
...
/* disable_{FxnT,fxnP} */
typedef xdc_Bool (*xdc_runtime_ILogger_disable_FxnT)(xdc_Void *__inst);
...
/* write0_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write0_FxnT)(xdc_Void *__inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid);
...
/* write1_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write1_FxnT)(xdc_Void *__inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1);
...
/* write2_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write2_FxnT)(xdc_Void *__inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2);
...
/* write4_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write4_FxnT)(xdc_Void *__inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4);
...
/* write8_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ILogger_write8_FxnT)(xdc_Void *__inst, xdc_runtime_Log_Event evt, xdc_runtime_Types_ModuleId mid, xdc_IArg a1, xdc_IArg a2, xdc_IArg a3, xdc_IArg a4, xdc_IArg a5, xdc_IArg a6, xdc_IArg a7, xdc_IArg a8);
