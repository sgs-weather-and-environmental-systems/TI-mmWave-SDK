...
struct xdc_runtime_IHeap_Fxns__ {
    ...
    xdc_Ptr (*alloc)(void* __inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb);
    xdc_Void (*free)(void* __inst, xdc_Ptr block, xdc_SizeT size);
    xdc_Bool (*isBlocking)(void* __inst);
    xdc_Void (*getStats)(void* __inst, xdc_runtime_Memory_Stats* stats);
...
__extern xdc_runtime_IHeap_Handle xdc_runtime_IHeap_create(xdc_runtime_IHeap_Module __mod, const xdc_runtime_IHeap_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_IHeap_delete, "xdc_runtime_IHeap_delete")
__extern xdc_Void xdc_runtime_IHeap_delete(xdc_runtime_IHeap_Handle *__inst);
...
/* alloc_{FxnT,fxnP} */
typedef xdc_Ptr (*xdc_runtime_IHeap_alloc_FxnT)(xdc_Void *__inst, xdc_SizeT size, xdc_SizeT align, xdc_runtime_Error_Block* eb);
...
/* free_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IHeap_free_FxnT)(xdc_Void *__inst, xdc_Ptr block, xdc_SizeT size);
...
typedef xdc_Bool (*xdc_runtime_IHeap_isBlocking_FxnT)(xdc_Void *__inst);
...
/* getStats_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IHeap_getStats_FxnT)(xdc_Void *__inst, xdc_runtime_Memory_Stats* stats);
