...
/* get32 */
static inline xdc_Bits32 xdc_runtime_ITimestampProvider_get32(xdc_runtime_ITimestampProvider_Module __mod);
static inline xdc_Bits32 xdc_runtime_ITimestampProvider_get32( xdc_runtime_ITimestampProvider_Module __mod )
{
    return __mod->get32();
}
...
/* get64 */
static inline xdc_Void xdc_runtime_ITimestampProvider_get64(xdc_runtime_ITimestampProvider_Module __mod, xdc_runtime_Types_Timestamp64 *result);
static inline xdc_Void xdc_runtime_ITimestampProvider_get64( xdc_runtime_ITimestampProvider_Module __mod, xdc_runtime_Types_Timestamp64 *result )
{
    __mod->get64(result);
}
...
/* getFreq */
static inline xdc_Void xdc_runtime_ITimestampProvider_getFreq(xdc_runtime_ITimestampProvider_Module __mod, xdc_runtime_Types_FreqHz *freq);
static inline xdc_Void xdc_runtime_ITimestampProvider_getFreq( xdc_runtime_ITimestampProvider_Module __mod, xdc_runtime_Types_FreqHz *freq )
{
    __mod->getFreq(freq);
}
...
static inline xdc_runtime_ITimestampProvider_get32_FxnT xdc_runtime_ITimestampProvider_get32_fxnP(xdc_runtime_ITimestampProvider_Module __mod);
static inline xdc_runtime_ITimestampProvider_get32_FxnT xdc_runtime_ITimestampProvider_get32_fxnP(xdc_runtime_ITimestampProvider_Module __mod)
{
    return (xdc_runtime_ITimestampProvider_get32_FxnT)__mod->get32;
}

/* get64_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ITimestampProvider_get64_FxnT)(xdc_runtime_Types_Timestamp64* result);
static inline xdc_runtime_ITimestampProvider_get64_FxnT xdc_runtime_ITimestampProvider_get64_fxnP(xdc_runtime_ITimestampProvider_Module __mod);
static inline xdc_runtime_ITimestampProvider_get64_FxnT xdc_runtime_ITimestampProvider_get64_fxnP(xdc_runtime_ITimestampProvider_Module __mod)
{
    return (xdc_runtime_ITimestampProvider_get64_FxnT)__mod->get64;
}

/* getFreq_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_ITimestampProvider_getFreq_FxnT)(xdc_runtime_Types_FreqHz* freq);
static inline xdc_runtime_ITimestampProvider_getFreq_FxnT xdc_runtime_ITimestampProvider_getFreq_fxnP(xdc_runtime_ITimestampProvider_Module __mod);
static inline xdc_runtime_ITimestampProvider_getFreq_FxnT xdc_runtime_ITimestampProvider_getFreq_fxnP(xdc_runtime_ITimestampProvider_Module __mod)
{
    return (xdc_runtime_ITimestampProvider_getFreq_FxnT)__mod->getFreq;
}
