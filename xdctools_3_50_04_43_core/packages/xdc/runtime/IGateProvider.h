...
__extern xdc_runtime_IGateProvider_Handle xdc_runtime_IGateProvider_create(xdc_runtime_IGateProvider_Module __mod, const xdc_runtime_IGateProvider_Params *__prms, xdc_runtime_Error_Block *__eb);

/* delete */
xdc__CODESECT(xdc_runtime_IGateProvider_delete, "xdc_runtime_IGateProvider_delete")
__extern xdc_Void xdc_runtime_IGateProvider_delete(xdc_runtime_IGateProvider_Handle *__inst);
...
/* enter_{FxnT,fxnP} */
typedef xdc_IArg (*xdc_runtime_IGateProvider_enter_FxnT)(xdc_Void *__inst);
...
/* leave_{FxnT,fxnP} */
typedef xdc_Void (*xdc_runtime_IGateProvider_leave_FxnT)(xdc_Void *__inst, xdc_IArg key);
