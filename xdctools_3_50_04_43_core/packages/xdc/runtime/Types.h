...
/* LoggerFxn0 */
typedef xdc_Void (*xdc_runtime_Types_LoggerFxn0)(xdc_Ptr __arg1, xdc_runtime_Types_LogEvent __arg2, xdc_runtime_Types_ModuleId __arg3);

/* LoggerFxn1 */
typedef xdc_Void (*xdc_runtime_Types_LoggerFxn1)(xdc_Ptr __arg1, xdc_runtime_Types_LogEvent __arg2, xdc_runtime_Types_ModuleId __arg3, xdc_IArg __arg4);

/* LoggerFxn2 */
typedef xdc_Void (*xdc_runtime_Types_LoggerFxn2)(xdc_Ptr __arg1, xdc_runtime_Types_LogEvent __arg2, xdc_runtime_Types_ModuleId __arg3, xdc_IArg __arg4, xdc_IArg __arg5);

/* LoggerFxn4 */
typedef xdc_Void (*xdc_runtime_Types_LoggerFxn4)(xdc_Ptr __arg1, xdc_runtime_Types_LogEvent __arg2, xdc_runtime_Types_ModuleId __arg3, xdc_IArg __arg4, xdc_IArg __arg5, xdc_IArg __arg6, xdc_IArg __arg7);

/* LoggerFxn8 */
typedef xdc_Void (*xdc_runtime_Types_LoggerFxn8)(xdc_Ptr __arg1, xdc_runtime_Types_LogEvent __arg2, xdc_runtime_Types_ModuleId __arg3, xdc_IArg __arg4, xdc_IArg __arg5, xdc_IArg __arg6, xdc_IArg __arg7, xdc_IArg __arg8, xdc_IArg __arg9, xdc_IArg __arg10, xdc_IArg __arg11);
...
struct xdc_runtime_Types_SysFxns2 {
    xdc_Ptr (*__create)(xdc_CPtr __arg1, const xdc_UChar* __arg2, xdc_SizeT __arg3, xdc_runtime_Error_Block* __arg4);
    xdc_Void (*__delete)(xdc_Ptr __arg1);
    xdc_runtime_Types_Label *(*__label)(xdc_Ptr __arg1, xdc_runtime_Types_Label* __arg2);
...
static inline xdc_Bool xdc_runtime_Types_Module_hasMask(void) 
{
    return (xdc_Bool)(xdc_runtime_Types_Module__diagsMask__C != NULL);
}
...
static inline xdc_Bits16 xdc_runtime_Types_Module_getMask( void ) 
{
    return xdc_runtime_Types_Module__diagsMask__C != NULL ? *xdc_runtime_Types_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void xdc_runtime_Types_Module_setMask(xdc_Bits16 mask)
{
    if (xdc_runtime_Types_Module__diagsMask__C != NULL) {
