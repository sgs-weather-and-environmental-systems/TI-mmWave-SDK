...
#  include <s__ios.h>                  // For basic_ios<>.  Includes <iosfwd>.
#endif

#ifndef _STLP_INTERNAL_OSTREAM_H
#  include <s__ostream.h>              // Needed as a base class of basic_iostream.
#endif

#ifndef _STLP_INTERNAL_ISTREAMBUF_ITERATOR_H
#  include <s__istreambuf_iterator.h>
#endif

#include <s__ctraits_fns.h>    // Helper functions that allow char traits
...
public:                         // Constructor and destructor.
  ...
  explicit basic_istream(ios_base::_SpecialInitType __i) :
    basic_ios<_CharT, _Traits>(__i) { /* Do nothing */ }
  ~basic_istream() {};
