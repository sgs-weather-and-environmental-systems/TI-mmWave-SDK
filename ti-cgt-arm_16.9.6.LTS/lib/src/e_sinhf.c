...
_DATA_ACCESS static const float one = 1.0, shuge = 1.0e37;
...
double sinh(double x) __attribute__((__alias__("sinhf")));
#endif

#if LDBL_MANT_DIG == FLT_MANT_DIG
long double sinhl(long double x) __attribute__((__alias__("sinhf")));
#endif
