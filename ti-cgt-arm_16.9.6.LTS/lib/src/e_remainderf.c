...
double remainder(double x, double p) __attribute__((__alias__("remainderf")));
#endif

#if LDBL_MANT_DIG == FLT_MANT_DIG
long double remainderl(long double x, long double p) __attribute__((__alias__("remainderf")));
#endif
