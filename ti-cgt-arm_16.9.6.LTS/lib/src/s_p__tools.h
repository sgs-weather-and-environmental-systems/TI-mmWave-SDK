...
struct _StorageType {
  ...
  typedef _Tp _Type;
  enum __attribute__((__packed__)) { use_const_volatile_void_ptr = 0 };
};
...
struct _StorageType<_Tp*> {
  ...
  enum __attribute__((__packed__)) { use_void_ptr = (sizeof(_UseVoidPtrStorageType(__true_type(),
                                                       __STATIC_CAST(_Tp*, 0))) == sizeof(char*)) };
  enum __attribute__((__packed__)) { use_const_volatile_void_ptr = use_void_ptr };
...
struct _StorageType<_Tp const*> {
  enum __attribute__((__packed__)) { use_void_ptr = (sizeof(_UseConstVoidPtrStorageType(__true_type(),
...
struct _StorageType<_Tp volatile*> {
  enum __attribute__((__packed__)) { use_void_ptr = (sizeof(_UseVolatileVoidPtrStorageType(__true_type(),
...
struct _StorageType<_Tp const volatile*> {
  enum __attribute__((__packed__)) { use_void_ptr = (sizeof(_UseConstVolatileVoidPtrStorageType(__true_type(),
...
struct _StorageType {
  ...
  enum __attribute__((__packed__)) { use_void_ptr = (sizeof(_UseVoidPtrStorageType(_PODType(), __null_rep())) == sizeof(char*)) };
  enum __attribute__((__packed__)) { use_const_void_ptr = (sizeof(_UseConstVoidPtrStorageType(_PODType(), __null_rep())) == sizeof(char*)) };
  enum __attribute__((__packed__)) { use_volatile_void_ptr = (sizeof(_UseVolatileVoidPtrStorageType(_PODType(), __null_rep())) == sizeof(char*)) };
  enum __attribute__((__packed__)) { use_const_volatile_void_ptr = (sizeof(_UseConstVolatileVoidPtrStorageType(_PODType(), __null_rep())) == sizeof(char*)) };
...
struct _AssocStorageTypes {
  ...
  enum __attribute__((__packed__)) { ptr_type = _StorageTypeInfo::use_const_volatile_void_ptr };
  typedef typename _IsSTLportClass<_Compare>::_Ret _STLportLess;
  enum __attribute__((__packed__)) { is_default_less = __type2bool<_STLportLess>::_Ret };
