...
_DATA_ACCESS static const float tiny = 1e-30;
...
double erf (double x) __attribute__((__alias__("erff")));
double erfc(double x) __attribute__((__alias__("erfcf")));
#endif

#if LDBL_MANT_DIG == FLT_MANT_DIG
long double erfl (long double x) __attribute__((__alias__("erff")));
long double erfcl(long double x) __attribute__((__alias__("erfcf")));
#endif
