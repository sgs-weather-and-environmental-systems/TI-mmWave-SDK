...
#if defined (_STLP_HAS_NO_NEW_C_HEADERS) && !defined (_STLP_VENDOR_GLOBAL_CSTD) && !defined(_STLP_VENDOR_CSTD)
...
#  elif  defined (_STLP_VENDOR_GLOBAL_CSTD) || !defined(_STLP_USE_NEW_C_HEADERS)
...
#  define _STLP_STATIC_CONSTANT(__type, __assignment) enum __attribute__((__packed__)) { __assignment }
#else
#    define _STLP_STATIC_CONSTANT(__type, __assignment) static const _DATA_ACCESS __type __assignment
#endif
