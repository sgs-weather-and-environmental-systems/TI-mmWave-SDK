...
_DATA_ACCESS static const float huge = 1.0e+30;
...
double expm1(double x) __attribute__((__alias__("expm1f")));
#endif

#if LDBL_MANT_DIG == FLT_MANT_DIG
long double expm1l(long double x) __attribute__((__alias__("expm1f")));
#endif
