...
template <class _Tp> struct _IsRef {
  enum __attribute__((__packed__)) { _Is = ::boost::is_reference<_Tp>::value };
  typedef typename __bool2type<_Is>::_Ret _Ret;
};

template <class _Tp> struct _IsPtr {
  enum __attribute__((__packed__)) { is_pointer = ::boost::is_pointer<_Tp>::value };
  typedef typename __bool2type<is_pointer>::_Ret _Ret;
};

template <class _Tp> struct _IsIntegral {
  enum __attribute__((__packed__)) { is_integral = ::boost::is_integral<_Tp>::value };
  typedef typename __bool2type<is_integral>::_Ret _Ret;
};

template <class _Tp> struct _IsRational {
  enum __attribute__((__packed__)) { is_float = ::boost::is_float<_Tp>::value };
  typedef typename __bool2type<is_float>::_Ret _Ret;
};

template <class _Tp>
struct __type_traits {
  enum __attribute__((__packed__)) { trivial_constructor = ::boost::has_trivial_constructor<_Tp>::value };
  typedef typename __bool2type<trivial_constructor>::_Ret has_trivial_default_constructor;

  enum __attribute__((__packed__)) { trivial_copy = ::boost::has_trivial_copy<_Tp>::value };
  typedef typename __bool2type<trivial_copy>::_Ret has_trivial_copy_constructor;

  enum __attribute__((__packed__)) { trivial_assign = ::boost::has_trivial_assign<_Tp>::value };
  typedef typename __bool2type<trivial_assign>::_Ret has_trivial_assignment_operator;

  enum __attribute__((__packed__)) { trivial_destructor = ::boost::has_trivial_destructor<_Tp>::value };
  typedef typename __bool2type<trivial_destructor>::_Ret has_trivial_destructor;

  enum __attribute__((__packed__)) { pod = ::boost::is_pod<_Tp>::value };
...
struct _TrivialCopy {
  ...
  enum __attribute__((__packed__)) { same = ::boost::is_same<uncv1, uncv2>::value };
  typedef typename __bool2type<same>::_Ret _Same;

  enum __attribute__((__packed__)) { boost_trivial_assign = ::boost::has_trivial_assign<uncv1>::value };
...
struct _TrivialUCopy {
  ...
  enum __attribute__((__packed__)) { boost_trivial_copy = ::boost::has_trivial_copy<uncv1>::value };
...
struct _TrivialInit {
  ...
  enum __attribute__((__packed__)) { boost_trivial_constructor = ::boost::has_trivial_constructor<uncv>::value };
