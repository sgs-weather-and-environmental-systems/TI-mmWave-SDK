...
enum __attribute__((__packed__)) float_round_style {
...
enum __attribute__((__packed__)) float_denorm_style {
...
/* Dinkumware expects for an argument to be given to the constructor
 * for __number below in their validation. */
#  define _NUMERIC_CONSTR_ARG 0
#else
#  define _NUMERIC_CONSTR_ARG
#endif
...
public:
  ...
  static __number (_STLP_CALL min)() _STLP_NOTHROW { return __number(_NUMERIC_CONSTR_ARG); }
  static __number (_STLP_CALL max)() _STLP_NOTHROW { return __number(_NUMERIC_CONSTR_ARG); }
  ...
  static __number _STLP_CALL epsilon() _STLP_NOTHROW     { return __number(_NUMERIC_CONSTR_ARG); }
  static __number _STLP_CALL round_error() _STLP_NOTHROW { return __number(_NUMERIC_CONSTR_ARG); }

  static __number _STLP_CALL infinity() _STLP_NOTHROW      { return __number(_NUMERIC_CONSTR_ARG); }
  static __number _STLP_CALL quiet_NaN() _STLP_NOTHROW     { return __number(_NUMERIC_CONSTR_ARG); }
  static __number _STLP_CALL signaling_NaN() _STLP_NOTHROW { return __number(_NUMERIC_CONSTR_ARG); }
  static __number _STLP_CALL denorm_min() _STLP_NOTHROW    { return __number(_NUMERIC_CONSTR_ARG); }
};

#undef _NUMERIC_CONSTR_ARG
...
#if defined(__TI_40BIT_LONG__)
/*****************************************************************************/
/* Special handling for TI 40 bit long.  This is necessary due to            */
/* sizeof(long) returning 8 and not 5.                                       */
/*****************************************************************************/
template <
          unsigned long __imin,
          unsigned long __imax,
          int __idigits, bool __ismod>
class _Integer_limits<unsigned long, __imin, __imax, __idigits, __ismod> : public _Numeric_limits_base<unsigned long> {
public:

  static unsigned long (_STLP_CALL min) () _STLP_NOTHROW { return (unsigned long)__imin; }
  static unsigned long (_STLP_CALL max) () _STLP_NOTHROW { return (unsigned long)__imax; }

  _STLP_STATIC_CONSTANT(int, digits = 40);
  _STLP_STATIC_CONSTANT(int, digits10 = 12);
  _STLP_STATIC_CONSTANT(int, radix = 2);
  _STLP_STATIC_CONSTANT(bool, is_specialized = true);
  _STLP_STATIC_CONSTANT(bool, is_signed = (__imin != 0));
  _STLP_STATIC_CONSTANT(bool, is_integer = true);
...
template <
          ...
          long __imax,
          int __idigits, bool __ismod>
class _Integer_limits<long, __imin, __imax, __idigits, __ismod> : public _Numeric_limits_base<long> {
public:

  static long(_STLP_CALL min) () _STLP_NOTHROW { return (long)__imin; }
  static long(_STLP_CALL max) () _STLP_NOTHROW { return (long)__imax; }

  _STLP_STATIC_CONSTANT(int, digits = 39);
  _STLP_STATIC_CONSTANT(int, digits10 = 11);
  _STLP_STATIC_CONSTANT(int, radix = 2);
  _STLP_STATIC_CONSTANT(bool, is_specialized = true);
  _STLP_STATIC_CONSTANT(bool, is_signed = (__imin != 0));
  _STLP_STATIC_CONSTANT(bool, is_integer = true);
...
/*****************************************************************************/
/* Subnormals are not fully supported.                                       */
/*****************************************************************************/
